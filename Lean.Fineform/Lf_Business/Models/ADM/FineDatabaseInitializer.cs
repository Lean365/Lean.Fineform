...
namespace Fine
{
    public class FineDatabaseInitializer : DropCreateDatabaseIfModelChanges<FineContext>  // DropCreateDatabaseAlways<BaseKitContext>  DropCreateDatabaseIfModelChanges<BaseKitContext>
    {
        [SecurityCritical]
        protected override void Seed(FineContext context)
        {
           ...
           // context.Database.ExecuteSqlCommand("DBCC CHECKIDENT ('Qm_Complaint', RESEED, 720000001)");
            ...
            string InsertEfficiency = "INSERT INTO[dbo].[Pp_Efficiency]([GUID],[Proratedate],[Prorate],[UDF01],[UDF02],[UDF03],[UDF04],[UDF05]" +
                                        ",[UDF06],[UDF51],[UDF52],[UDF53],[UDF54],[UDF55],[UDF56],[isDelete],[Remark],[Creator],[CreateTime])SELECT newid(),cast([TheYear] as varchar)+RIGHT('0000000'+CONVERT(VARCHAR(50),cast([TheMonth] as varchar)),2),85," +
        ...
        private static List<Adm_Menu> GetAdm_Menus(FineContext context)
        {
        ...
        private static List<Adm_Config> GetAdm_Configs()
        {
            var Adm_Configs = new List<Adm_Config> {
                new Adm_Config
                {
                    ...
                    ConfigKey= "Adm_Title",
                    ConfigValue= "Lean365（Lean.Fineform）",
                    Remark = "网站的标题"
                },
                new Adm_Config
                {
