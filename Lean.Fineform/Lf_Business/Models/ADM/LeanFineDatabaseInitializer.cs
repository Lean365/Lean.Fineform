                        ...
                        new Adm_Menu {
                            ...
                            Children = new List<Adm_Menu>
                            {
                                ...
                                new Adm_Menu
                                {
                                    ...
                                    SortIndex = 120,
                                    Remark = "三级菜单",
                                    NavigateUrl = "~/Lf_Manufacturing/PP/daily/P1D/p1d_epp_daily.aspx",
                                    ImageUrl = "~/Lf_Resources/menu/prorepaired.png",
                                    ButtonName="Btn_Lf_Pp_"+"p1d_daily",
                                    ViewPower = context.Adm_Powers.Where(p => p.Name == "CoreP1DOutputView").FirstOrDefault<Adm_Power>()
                                },
                        ...
                        new Adm_Menu {
                            ...
                            Children = new List<Adm_Menu>
                            {
                                ...
                                new Adm_Menu
                                {
                                    ...
                                    SortIndex = 130,
                                    Remark = "三级菜单",
                                    NavigateUrl = "~/Lf_Manufacturing/PP/poor/P1D/p1d_epp_defect.aspx",
                                    ImageUrl = "~/Lf_Resources/menu/prorepaired.png",
                                    ButtonName="Btn_Lf_Pp_"+"p1d_defect",
                                    ViewPower = context.Adm_Powers.Where(p => p.Name == "CoreP1DDefectView").FirstOrDefault<Adm_Power>()
                                },
                                new Adm_Menu
                                {
                                    ...
                                    SortIndex = 140,
                                    Remark = "三级菜单",
                                    NavigateUrl = "~/Lf_Manufacturing/PP/poor/P1D/pp_defect_order.aspx",
                                    ImageUrl = "~/Lf_Resources/menu/prostats.png",
                                    ButtonName="Btn_Lf_Pp_"+"pp_defect_order",
                                    ViewPower = context.Adm_Powers.Where(p => p.Name == "CoreP1DDefectView").FirstOrDefault<Adm_Power>()
                                },
                                new Adm_Menu
                                {
        ...
        private static List<Adm_Power> GetAdm_Powers()
        {
            string[] Add_Items = {
                        ...
                        "CoreEcENGDelete","部门设变","删除设变信息ENG","~/Lf_Manufacturing/EC/ec_view.aspx",
                         "CoreEcENGSubDelete","部门设变","删除设变单身信息ENG","~/Lf_Manufacturing/EC/ec_view.aspx",
...
"208580","peng01@teac.com.cn","男","梁嘉敏","LIANG JIA MIN","制造技术课","专员","18","2uebrwJT",
...
"100057","yxf@teac.com.cn","女","杨详锋","YANG XIANG FENG","采购课","专员","13","UmpbnKax",
...
"E4150","takumi.iwasaki@teac.jp","男","岩﨑　巧","IWASAKI,TAKUMI","TCJ 開発本部 開発管理部 生産技術課","TCJ","24","8YEtMU5W",
"E3612","fumihiko.hosoya@teac.jp","男","細谷　文彦","HOSOYA,FUMIHIKO","TCJ 開発本部 開発管理部","TCJ","24","UmC9DQYd",
...
"line_type_p","1SMT1","SMT1","1","班组列表",
"line_type_p","1SMT2","SMT2","1","班组列表",
"line_type_p","2自插A","AIA","1","班组列表",
"line_type_p","2自插C","AIC","1","班组列表",
"line_type_p","2自插B","AIB","1","班组列表",
"line_type_p","2自插D","AID","1","班组列表",
"line_type_p","3手插A","MIA","1","班组列表",
"line_type_p","3手插B","MIB","1","班组列表",
"line_type_p","3手插C","MIC","1","班组列表",
"line_type_p","4修正A","RA","1","班组列表",
"line_type_p","4修正B","RB","1","班组列表",
"line_type_p","4修正C","RC","1","班组列表",
