...
namespace LeanFine.Lf_Business.Helper
{
    public class UpdateP1dHelper : PageBase
    {
        ...
        /// </summary>
        /// <param name="strPorder"></param>
        public static void Pp_P1d_Defect_Orders_Update_For_Realqty(string strPorder, string uid, string strProdept)
        {
            int realQty = 0;
        ...
        /// </summary>
        /// <param name="strPorder"></param>
        public static void Pp_P1d_Defect_Orders_Update_For_NoBadQty(string strPorder, string uid, string strProdept)
        {
            int noQty = 0;
            int okQty = 0;
            var noqs =
        ...
        /// </summary>
        /// <param name="strPorder"></param>
        public static void Pp_P1d_Defect_Orders_Update_For_BadQtyTotal(string strPorder, string uid, string strProdept)
        {
            int BadTotalQty = 0;
