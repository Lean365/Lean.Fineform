...
namespace LeanFine
{
    public class ProceduerHelper : PageBase
    {
        ...
        " INSERT INTO Adm_TheDate(TheYear, TheMonth, TheDay, TheWeekDay, TheWeeks, TheMonths, IsWorkDay,TheDatetime, Guid, UDF01,UDF02,UDF03,UDF04,UDF05,UDF06,UDF51,UDF52,UDF53,UDF54,UDF55,UDF56,IsDeleted,CREATOR, CreateDate)" +
        ...
        " ,convert(varchar(20),dateadd(dd,number,convert(varchar(5),@dDate,120)+'01-01'),120) as TheDatetime " +
            "  , NEWID() AS Guid" +
        " ,''as UDF01,''as UDF02,''as UDF03,''as UDF04,''as UDF05,''as UDF06,0 as UDF51,0 as UDF52,0 as UDF53,0 as UDF54,0 as UDF55,0 as UDF56, 0 as IsDeleted, @Year+'Admin' AS CREATOR" +
