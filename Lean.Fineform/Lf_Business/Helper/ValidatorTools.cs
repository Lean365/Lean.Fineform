...
namespace Fine
{
    ...
    public class ValidatorTools
    {
        ...
        {
            System.Text.RegularExpressions.Regex reg1 = new System.Text.RegularExpressions.Regex(@"^[a-zA-Z][A-Za-z0-9-]+$");
        ...
        //只允许指定字符开头,数字或或-的判断
        public static bool isDTS(string content)
        {
            System.Text.RegularExpressions.Regex reg1 = new System.Text.RegularExpressions.Regex(@" ^\d{3,4}$");
            return reg1.IsMatch(content);

        }
        //只允许指定字符开头,数字或或-的判断
        public static bool isPP(string content)
        {
            System.Text.RegularExpressions.Regex reg1 = new System.Text.RegularExpressions.Regex(@"^P-[0-9]+$");
            return reg1.IsMatch(content);

        }
        //只允许指定字符开头,数字或或-的判断
        public static bool isLOT(string content)
        {
            System.Text.RegularExpressions.Regex reg1 = new System.Text.RegularExpressions.Regex(@"^[A-Z][A-Z0-9_]+$");
            return reg1.IsMatch(content);

        }
        //只允许指定字符开头,数字或或-的判断
        public static bool isVEN(string content)
        {
            System.Text.RegularExpressions.Regex reg1 = new System.Text.RegularExpressions.Regex(@"^H[0-9]+$");
            return reg1.IsMatch(content);

        }

        //只允许指定字符开头,数字或或-的判断
        public static bool isPO(string content)
        {
            System.Text.RegularExpressions.Regex reg1 = new System.Text.RegularExpressions.Regex(@"^(0|43[0-9]*)$");
            return reg1.IsMatch(content);
