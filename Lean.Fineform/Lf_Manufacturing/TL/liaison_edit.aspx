<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="liaison_edit.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.TL.liaison_edit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow ID="FormRow3" runat="server">
                            <Items>
                                <f:DropDownList ID="Ec_model" runat="server" Label="机种" ShowRedStar="True" EmptyText="<%$ Resources:GlobalResource,Query_Select%>" EnableEdit="true">
                                </f:DropDownList>
                            </Items>
                        </f:FormRow>
