<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_model_kanban_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_model_kanban_edit" %>
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                ...
                                <f:DropDownList runat="server" ID="ddlP_Kanban_Line" Label="生产班组" EnableEdit="true" ShowRedStar="True" EmptyText="<%$ Resources:GlobalResource,Query_Select%>">
                                </f:DropDownList>
