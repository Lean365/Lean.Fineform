<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_models_region_new.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_models_region_new" %>
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                ...
                                <f:DropDownList runat="server" ID="ddlD_SAP_DEST_Z001" Label="物料" AutoPostBack="true" ShowRedStar="True" EmptyText="<%$ Resources:GlobalResource,Query_Select%>" OnSelectedIndexChanged="ddlD_SAP_DEST_Z001_SelectedIndexChanged">
                                </f:DropDownList>
