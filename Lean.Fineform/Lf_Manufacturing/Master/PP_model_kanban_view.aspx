<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_model_kanban_view.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_model_kanban_view" %>
...
<body>
                ...
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <%--<f:Button ID="btn_PrintPreview" ValidateForms="SimpleForm1" IconUrl="~/Lf_Resources/icon/PrintView.png"
                            EnablePostBack="false" OnClientClick="CreateAllPages_PREVIEW()" runat="server" Text="<%$ Resources:GlobalResource,sys_Button_Preview%>">
                        </f:Button>--%>
                        <%--<f:Button ID="btn_PrintDesign" ValidateForms="SimpleForm1" IconUrl="~/Lf_Resources/icon/PrintDesign.png"
                            EnablePostBack="false" OnClientClick="CreateNewPages()" runat="server" Text="<%$ Resources:GlobalResource,sys_Button_Design%>">
                        </f:Button>--%>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        //var strPqrcode = '<%=lblP_Kanban_Date.Text%>';
        ...
        function CreateAllPages_PREVIEW() {    //一个任务中循环多页，每页内容不同
            LODOP = getLodop();
            ...
            for (i = 1; i < count; i++) {
                LODOP.NewPage();
                //LODOP.PRINT_INITA(0, 0, 703, 431, "套打模板");
                LODOP.ADD_PRINT_SETUP_BKIMG("H:\\VS2019\\设变DB项目\\0302A.jpg");
                LODOP.SET_SHOW_MODE("BKIMG_PRINT", true);
                LODOP.ADD_PRINT_BARCODE(1, 1, 64, 64, "QRCode", strPdate + strPline + strPmodel + strPlot + strPregion + i);

                //打印LOGO
                LODOP.ADD_PRINT_HTM(25, 25, 83, 20, "<img src='/Lf_Resources/images/FileLogo.png'/>");
                LODOP.SET_PRINT_STYLEA(0, "Stretch", 1);
                //打印标题
                LODOP.ADD_PRINT_TEXT(27, 240, 300, 30, "东莞蒂雅克电子有限公司");
                LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
                LODOP.SET_PRINT_STYLEA(0, "FontSize", 16);
                LODOP.SET_PRINT_STYLEA(0, "Alignment", 2);

                LODOP.ADD_PRINT_TEXT(6, 600, 60, 20, strPdate);
                LODOP.ADD_PRINT_TEXT(45, 198, 40, 20, strPline);
                LODOP.ADD_PRINT_TEXT(45, 280, 80, 20, strPmodel);
                LODOP.ADD_PRINT_TEXT(45, 420, 90, 20, strPlot);
                LODOP.ADD_PRINT_TEXT(70, 94, 80, 20, strPregion);
                LODOP.SET_PRINT_STYLEA(0, "QRCodeVersion", 3);
                LODOP.SET_PRINT_STYLEA(0, "DataCharset", "UTF-8");
        ...
        function CreateAllPages_DESIGN() {    //一个任务中循环多页，每页内容不同
            LODOP = getLodop();
            LODOP.PRINT_INIT("");//初始化在循环外
            ...
            for (i = 1; i < count; i++) {
                ...
                LODOP.ADD_PRINT_TEXT(90, 400, 100, 20, strPlot);
                LODOP.ADD_PRINT_TEXT(123, 112, 80, 20, strPregion);
                LODOP.ADD_PRINT_BARCODE(10, 39, 64, 64, "QRCode", strPdate + strPline + strPmodel + strPlot + strPregion + i);
                LODOP.SET_PRINT_STYLEA(0, "QRCodeVersion", 3);
                LODOP.SET_PRINT_STYLEA(0, "DataCharset", "UTF-8");
            }
            LODOP.PRINT_DESIGN();
