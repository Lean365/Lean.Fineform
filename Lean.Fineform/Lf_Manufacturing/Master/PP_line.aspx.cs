...
{
    public partial class Pp_line : PageBase
    {
        #region ViewPower
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("~/Lf_Manufacturing/Master/Pp_line_new.aspx", "新增");
        ...
        {
            IQueryable<Pp_Line> q = DB.Pp_Lines; //.Include(u => u.Dept);

            // 在用户名称中搜索
            string searchText = ttbSearchMessage.Text.Trim();
            if (!String.IsNullOrEmpty(searchText))
            {
                q = q.Where(u => u.lineclass.Contains(searchText) || u.linecode.Contains(searchText)); //|| u.CreateTime.Contains(searchText));
            }
