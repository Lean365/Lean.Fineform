<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qm_acceptcat.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Qm_acceptcat" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"  
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    DataKeyNames="GUID,Checktype" AllowSorting="true" OnSort="Grid1_Sort"  SortField="Checktype"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Checktype" SortField="Checktype"  Width="100px" HeaderText="类别" />
                        <f:BoundField DataField="Checkcntext" SortField="Checkcntext"  Width="100px" HeaderText="名称" /> 
