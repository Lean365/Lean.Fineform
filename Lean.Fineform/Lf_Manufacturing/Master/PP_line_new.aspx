<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_line_new.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_line_new" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:TextBox runat="server"  Label="班组类别"     ID="lineclass" ShowRedStar="True" EmptyText="制二课请输入：P,制一课请输入：M,品保部请输入：Q" CompareMessage="只能输入：P或M或Q" Required="True">
                                </f:TextBox>
