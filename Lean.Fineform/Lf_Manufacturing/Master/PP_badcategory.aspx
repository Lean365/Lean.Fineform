<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_badcategory.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_badcategory" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    DataKeyNames="GUID,ngclass" AllowSorting="true" OnSort="Grid1_Sort" SortField="ngclass"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="ngclass" SortField="ngclass" Width="100px" HeaderText="不良类别" />
                        <f:BoundField DataField="cn_classmatter" SortField="cn_classmatter" Width="100px" HeaderText="类别名称" />
                        <f:BoundField DataField="ngcode" SortField="ngcode" Width="100px" HeaderText="不良代码" />
                        <f:BoundField DataField="cn_ngmatter" SortField="cn_ngmatter" Width="100px" HeaderText="代码名称" />
