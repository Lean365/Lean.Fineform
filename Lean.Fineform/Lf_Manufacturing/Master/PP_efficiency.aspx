<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_efficiency.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_efficiency" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"  
            ...
            ShowHeader="false" Title="生产赁率">
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    EnableCheckBoxSelect="true" ForceFit="true"
                    DataKeyNames="GUID" AllowSorting="true" OnSort="Grid1_Sort"  SortField="Proratedate"
                    SortDirection="ACS" AllowPaging="true" IsDatabasePaging="true" OnPreDataBound="Grid1_PreDataBound"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Proratedate" SortField="Proratedate"  Width="100px" HeaderText="日期" />
                        <f:BoundField DataField="Prorate" SortField="Prorate"  Width="100px" HeaderText="赁率" />                          
