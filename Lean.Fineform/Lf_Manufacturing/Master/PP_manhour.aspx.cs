    ...
    public partial class Pp_manhour : PageBase
    {
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                PageContext.RegisterStartupScript(Window1.GetShowReference("~/Lf_Manufacturing/Master/Pp_manhour_edit.aspx?GUID=" + keys[0].ToString() + "&type=1"));//+ Window1.GetMaximizeReference()窗口最大化+ Window1.GetMaximizeReference());
            }
