<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_transport.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_transport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"  
            ...
            ShowHeader="false" Title="运输目的地类别">
            <Items>

                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    EnableCheckBoxSelect="true" ForceFit="true" EnableTextSelection="true"
                    DataKeyNames="GUID,Transportype" AllowSorting="true" OnSort="Grid1_Sort"  SortField="Transportype"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Transportype" SortField="Transportype"  Width="100px" HeaderText="运输类别" />
                        <f:BoundField DataField="Transportcntext" SortField="Transportcntext"  Width="100px" HeaderText="目的地" /> 
