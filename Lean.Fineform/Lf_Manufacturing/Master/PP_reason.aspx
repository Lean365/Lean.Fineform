<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_reason.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_reason" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"  
            ...
            ShowHeader="false" Title="生产异常类别">
            <Items>

                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    EnableCheckBoxSelect="true" ForceFit="true" EnableTextSelection="true"
                    DataKeyNames="GUID,Reasontype" AllowSorting="true" OnSort="Grid1_Sort"  SortField="Reasontype"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Reasontype" SortField="Reasontype"  Width="100px" HeaderText="异常名称" />
                        <f:BoundField DataField="Reasoncntext" SortField="Reasoncntext"  Width="100px" HeaderText="异常名称" /> 
