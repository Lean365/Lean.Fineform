<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qm_acceptcat_edit.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.Master.qm_acceptcat_edit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:Label runat="server"  Label="类别"  ID="Checktype" ShowRedStar="True">
                                </f:Label>                                                                
                                </Items>
                        </f:FormRow>
