<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pp_manhour_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.Master.Pp_manhour_edit" %>
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow4" runat="server">
                            <Items>
                                 ...
                                 <f:DatePicker runat="server"  Label="更新日期"  FocusOnPageLoad="true"   ID="Prodate" ShowRedStar="True"  DateFormatString="yyyy-MM-dd" EmptyText="<%$ Resources:GlobalResource,Query_Select%>" LabelAlign="Right" Required="True">
                                </f:DatePicker>                      
                                </Items>
                        </f:FormRow>
                        ...
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:Label runat="server"  Label="生产物料"   ID="Proitem" ShowRedStar="true"   LabelAlign="Right" >
                                </f:Label>
                                 <f:Label runat="server" ID="Protext" Label="物料文本" ShowRedStar="True" LabelAlign="Right">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow6" runat="server">
                            <Items>
                                <f:Label runat="server"  Label="生产机种"   ID="Promodel" ShowRedStar="True" LabelAlign="Right">
                                </f:Label>  
                        ...
                        <f:FormRow ID="FormRow7" runat="server">
                            <Items>
                                <f:Label runat="server"  Label="工作中心"   ID="Prowcname" ShowRedStar="true"   LabelAlign="Right" >
                                </f:Label>
                                <f:Label runat="server"  Label="工作文本"   ID="Prowctext" ShowRedStar="True" LabelAlign="Right">
                                </f:Label> 
                        ...
                        <f:FormRow ID="FormRow3" runat="server">
                            ...
                            <Items>
                                <f:NumberBox runat="server"  Label="换算汇率"   ID="Prorate" NoDecimal="false" NoNegative="True" DecimalPrecision="5" Required="True" ShowRedStar="True" LabelAlign="Right" EmptyText="0">
                                </f:NumberBox>
