<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fqc_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.QM.fqc.fqc_edit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" AutoScroll="true" runat="server">
                ...
                <f:Form ID="SimpleForm1" ShowBorder="true" ShowHeader="true" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow8" runat="server">
                            <Items>
                                <f:Label ID="Qacheckguid" runat="server" Label="GUID" ShowRedStar="true"></f:Label>
                                <f:Label ID="qmCheckout" runat="server" CssClass="brownlabel" Label="检验次数">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:Label runat="server" ID="qmLine" Label="班别">
                                </f:Label>
                                <f:Label runat="server" ID="qmInspector" Label="检查员">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow6" runat="server">
                            <Items>
                                ...
                                <f:Label runat="server" ID="qmCheckdate" Label="检查日期">
                                </f:Label>
                                <f:Label runat="server" ID="qmOrder" Label="生产工单">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow10" runat="server">
                            <Items>
                                <f:Label ID="qmModels" runat="server" Label="机种">
                                </f:Label>
                                <f:Label ID="qmMaterial" runat="server" Label="品号">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow21" runat="server">
                            <Items>
                                <f:Label ID="LaOrgin" runat="server" Label="仕向">
                                </f:Label>
                                <f:Label ID="LaText" runat="server" Label="品名">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:Label ID="qmProlot" runat="server" Label="生产批次">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow3" runat="server">
                            <Items>
                                <f:Label ID="qmOrderqty" runat="server" Label="订单数量">
                                </f:Label>
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" EnableAjax="false" EnableAjaxLoading="false" BoxFlex="1" ForceFit="true" ShowBorder="false" ShowHeader="false" AllowCellEditing="true" ClicksToEdit="2" EnableCheckBoxSelect="true"
                    ...
                    <Columns>
                        <f:LinkButtonField ColumnID="deleteField" TextAlign="Center" Icon="Delete" 
                            HeaderText="<%$ Resources:GlobalResource,sys_Button_Delete%>" ToolTip="删除"
