<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fqc_action_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.QM.fqc.fqc_action_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" IsFluid="true" CssClass="blockpanel" Height="350px" ShowBorder="true" TabPosition="Top"
            ...
            <Tabs>
                ...
                <f:Tab Title="分析对策[制造部]" BodyPadding="10px"
                    runat="server">
                    <Items>
                        <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                            ...
                            <Rows>
                                ...
                                <f:FormRow ID="FormRow9" runat="server">
                                    <Items>
                                        <f:TextArea runat="server" ID="qmDirectreason" Label="直接原因"
                                ...
                                <f:FormRow ID="FormRow15" runat="server">
                                    <Items>
                                        <f:TextArea runat="server" ID="qmIndirectreason" Label="间接原因"
                                ...
                                <f:FormRow ID="FormRow11" runat="server">
                                    <Items>
                                        <f:TextArea runat="server" ID="qmDisposal" Label="处置方式"
                ...
                <f:Tab Title="实施检证[品证部]" BodyPadding="10px" runat="server">
                    <Items>
                        <f:Form ID="Form3" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                            Title="实施检证[品证部]">
                            <Rows>
