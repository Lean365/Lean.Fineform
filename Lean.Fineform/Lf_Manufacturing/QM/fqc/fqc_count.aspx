<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fqc_count.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.QM.fqc.fqc_count" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" 
                    DataKeyNames="ID,Cdate" AllowSorting="true" OnSort="Grid1_Sort" SortField="Cdate" ForceFit="true" EnableTextSelection="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Clot" SortField="Clot" Width="100px" HeaderText="批次" />
                        <f:BoundField DataField="Cdate" SortField="Cdate" Width="100px" HeaderText="日期" />
                        <f:BoundField DataField="Pqty" SortField="Pqty" ColumnID="Pqty" Width="100px" HeaderText="送检数" />
                        <f:BoundField DataField="Aqty" SortField="Aqty" ColumnID="Aqty" Width="100px" HeaderText="验收数" />
                        <f:BoundField DataField="Rqty" SortField="Rqty" ColumnID="Rqty" Width="100px" HeaderText="验退数" />
                        <f:BoundField DataField="Passrate" SortField="Passrate" ColumnID="Passrate" Width="100px" HeaderText="合格率" DataFormatString="{0:p2}" />
                        <f:BoundField DataField="Failurerate" SortField="Failurerate" ColumnID="Failurerate" Width="100px" HeaderText="不合格率" DataFormatString="{0:p2}" />
