...
{
    public partial class complaint_p1d : PageBase
    {
        #region ViewPower
        ...
        private void LoadData()
        {
            ...
            //Btn_QA_New.OnClientClick = Window1.GetShowReference("~/Lf_Manufacturing/QM/complaint/complaint_qa_new.aspx", "新增") + Window1.GetMaximizeReference();
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (rbtnFirstAuto.Checked)
                {
                    ...
                    ExportHelper.EpplusToExcel(ConvertHelper.LinqConvertToDataTable(qs), Prefix_XlsxName, Export_FileName, "DTA 客诉明细");
