<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="complaint.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.QM.complaint.complaint" %>
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Cc_ReceivingDate" SortField="Cc_ReceivingDate" Width="100px" HeaderText="接收日期" />
                        <f:BoundField DataField="Cc_Customer" SortField="Cc_Customer" Width="100px" HeaderText="客户编号" />
                        <f:HyperLinkField DataTextField="Cc_IssuesNo" SortField="Cc_IssuesNo" Width="100px" HeaderText="客诉编号" DataNavigateUrlFields="Cc_Reference" />
                        <f:BoundField DataField="Cc_Model" SortField="Cc_Model" Width="100px" HeaderText="机种名" />
                        <f:BoundField DataField="Cc_Issues" SortField="Cc_Issues" Width="350px" HeaderText="投诉事项" />
                        <f:BoundField DataField="Cc_Reasons" SortField="Cc_Reasons" Width="350px" HeaderText="症状" />
