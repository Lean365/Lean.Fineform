<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wagerate_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.QM.cost.wagerate_edit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="true" ShowHeader="true" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow ID="FormRow6" runat="server">
                            <Items>
                                <f:Label runat="server" Label="年月" ID="Qcsd001" ShowRedStar="True">
                                </f:Label>
                                <f:Label ID="Qcsd005" runat="server" Label="总工作时日" ShowRedStar="True">
                                </f:Label>
                            </Items>
                        </f:FormRow>
                        <f:FormRow ID="FormRow10" runat="server">
                            <Items>
                                <f:Label runat="server" Label="币种" ID="Qcsd003" ShowRedStar="True">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:Label ID="Qcsdrec" runat="server" Label="财务担当" ShowRedStar="True">
                                </f:Label>
