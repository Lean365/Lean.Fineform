<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rework_cost_new.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.QM.cost.rework_cost_new" %>
                        ...
                        <f:Form ID="SimpleForm1" ShowBorder="true" ShowHeader="true" runat="server" BodyPadding="5px" Title="品质业务对应">
                            <Rows>
                                <f:FormRow ID="FormRow1" runat="server">
                                    <Items>
                                        <f:DatePicker LabelWidth="200px" LabelAlign="Right"  runat="server" Required="true" Label="日期" DateFormatString="yyyyMMdd" EmptyText="请输入日期"
                                            ID="Qcrd001" ShowRedStar="True" OnTextChanged="Qcrd001_TextChanged" AutoPostBack="True">
                                        </f:DatePicker>
                                ...
                                <f:FormRow ID="FormRow3" runat="server">
                                    <Items>
                                        <f:DropDownList LabelWidth="200px" LabelAlign="Right"  runat="server" ID="Qcrd002" Label="机种" ShowRedStar="True" EnableEdit="true" ForceSelection="true" AutoPostBack="True" EmptyText="<%$ Resources:GlobalResource,Query_Select%>" Text="请选择" OnSelectedIndexChanged="Qcrd002_SelectedIndexChanged">
                                        </f:DropDownList>
                                        <f:DropDownList LabelWidth="200px" LabelAlign="Right"  runat="server" ID="Qcrd003" Label="批次" ShowRedStar="True" EnableEdit="true" ForceSelection="true" AutoPostBack="True" EmptyText="<%$ Resources:GlobalResource,Query_Select%>" Text="请选择">
                                        </f:DropDownList>
                                    </Items>
                                </f:FormRow>
