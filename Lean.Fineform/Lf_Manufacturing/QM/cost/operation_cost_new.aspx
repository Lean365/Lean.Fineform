<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="operation_cost_new.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.QM.cost.operation_cost_new" %>
                        ...
                        <f:Form ID="SimpleForm1" ShowBorder="true" ShowHeader="true" runat="server" BodyPadding="5px" Title="受入检查业务费用">
                            <Rows>
                                ...
                                <f:FormRow ID="FormRow2" runat="server">
                                    <Items>
                                        <f:DatePicker LabelWidth="200px" LabelAlign="Right"  runat="server" Required="true" Label="年月" DateFormatString="yyyyMM" EmptyText="请输入日期"
                                            ID="Qcod001" ShowRedStar="True" OnTextChanged="Qcod001_TextChanged" AutoPostBack="True">
                                        </f:DatePicker>
