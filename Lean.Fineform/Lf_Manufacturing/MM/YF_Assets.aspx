<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YF_Assets.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.MM.YF_Assets" %>
                ...
                <f:Tab Title="C100" BodyPadding="10px" Layout="VBox" runat="server">
                    <Items>
                            ...
                            <Rows>
                                <f:FormRow ID="FormRow1" runat="server">
                                    <Items>
                                        ...
                                        <f:DatePicker ID="C_DpEndDate" Readonly="false" Width="300px" CompareControl="DpStartDate" DateFormatString="yyyyMMdd" AutoPostBack="true"
                        ...
                        <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" ForceFit="true"
                            DataKeyNames="MB002" AllowSorting="true" SortField="MB002" EnableTextSelection="true"
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="MB001" SortField="MB001" Width="100px" HeaderText="编号" />
                                <f:BoundField DataField="MB002" SortField="MB002" Width="100px" HeaderText="名称" />
                                <f:BoundField DataField="MB003" SortField="MB003" Width="100px" HeaderText="规格" />
                                <f:BoundField DataField="MA002" SortField="MA002" Width="100px" HeaderText="类别" />
                                <f:BoundField DataField="MB008" SortField="MB008" Width="100px" HeaderText="业者" />
                                <f:BoundField DataField="MB012" SortField="MB012" Width="100px" HeaderText="数量" />
                                <f:BoundField DataField="MB016" SortField="MB016" Width="100px" HeaderText="取得" />
                                <f:BoundField DataField="MB017" SortField="MB017" Width="100px" HeaderText="销账" />
                                <f:BoundField DataField="MB018" SortField="MB018" Width="100px" HeaderText="币种" />
                                <f:BoundField DataField="MB019" SortField="MB019" Width="100px" HeaderText="金额" />
                                <f:BoundField DataField="MB028" SortField="MB028" Width="100px" HeaderText="计提" />
                                <f:BoundField DataField="MB029" SortField="MB029" Width="100px" HeaderText="累计" />
                                <f:BoundField DataField="MB022" SortField="MB022" Width="100px" HeaderText="预净残" />
                                <f:BoundField DataField="MB049" SortField="MB049" Width="100px" HeaderText="年折旧" />
                                <f:BoundField DataField="MB014" SortField="MB014" Width="100px" HeaderText="耐用" />
                                <f:BoundField DataField="ME002" SortField="ME002" Width="100px" HeaderText="部门" />
                                <f:BoundField DataField="MV002" SortField="MV002" Width="100px" HeaderText="管理" />
                            ...
                            <Rows>
                                <f:FormRow ID="FormRow2" runat="server">
                                    <Items>
                                        ...
                                        <f:DatePicker ID="H_DpEndDate" Readonly="false" Width="300px" CompareControl="DpStartDate" DateFormatString="yyyyMMdd" AutoPostBack="true"
                                            CompareOperator="GreaterThan" CompareMessage="<%$ Resources:GlobalResource,Query_Enddate_EmptyText%>" Label="<%$ Resources:GlobalResource,Query_Enddate%>"
