<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yf_Assets.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.MM.Yf_Assets" %>
                            ...
                            <Rows>
                                <f:FormRow ID="FormRow1" runat="server">
                                    <Items>
                                        ...
                                        <f:DatePicker ID="C_DPend" Readonly="false" Width="300px" CompareControl="DPstart" DateFormatString="yyyyMMdd" AutoPostBack="true"
                            ...
                            <Rows>
                                <f:FormRow ID="FormRow2" runat="server">
                                    <Items>
                                        ...
                                        <f:DatePicker ID="H_DPend" Readonly="false" Width="300px" CompareControl="DPstart" DateFormatString="yyyyMMdd" AutoPostBack="true"
                                            CompareOperator="GreaterThan" CompareMessage="<%$ Resources:GlobalResource,Query_Enddate_EmptyText%>" Label="<%$ Resources:GlobalResource,Query_Enddate%>"
