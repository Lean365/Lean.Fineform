<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yf_Substitute.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.MM.Yf_Substitute" %>
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" ForceFit="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="MB001" Width="100px" HeaderText="元件" />
                        <f:BoundField DataField="MB002" Width="100px" HeaderText="主件" />
                        <f:BoundField DataField="MB003" Width="100px" HeaderText="替代料" />
                        <f:BoundField DataField="MB004" Width="100px" HeaderText="品号" />
                        <f:BoundField DataField="MB005" Width="100px" HeaderText="数量" />
                        <f:BoundField DataField="MB006" Width="100px" HeaderText="生效" />
                        <f:BoundField DataField="MB008" Width="100px" HeaderText="原因" />
                    </Columns>
                </f:Grid>
            </Items>
        </f:Panel>
