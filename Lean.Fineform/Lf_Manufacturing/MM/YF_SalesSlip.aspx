<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yf_SalesSlip.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.MM.Yf_SalesSlip" %>
                ...
                <f:Tab Title="C100" BodyPadding="10px" Layout="VBox" runat="server">
                    <Items>
                        ...
                        <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" ForceFit="true"
                            DataKeyNames="TH004" AllowSorting="true" SortField="TH004" EnableTextSelection="true"
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="TG001" SortField="TG001" Width="100px" HeaderText="销货" />
                                <f:BoundField DataField="TG003" SortField="TG003" Width="100px" HeaderText="日期" />
                                <f:BoundField DataField="MA002" SortField="MA002" Width="100px" HeaderText="客户" />
                                <f:BoundField DataField="TG011" SortField="TG011" Width="100px" HeaderText="币种" />
                                <f:BoundField DataField="TG040" SortField="TG040" Width="100px" HeaderText="发票" />
                                <f:BoundField DataField="TH004" SortField="TH004" Width="100px" HeaderText="物料" />
                                <f:BoundField DataField="TH005" SortField="TH005" Width="100px" HeaderText="描述" />
                                <f:BoundField DataField="TH008" SortField="TH008" Width="100px" HeaderText="数量" />
                                ...
                                <f:BoundField DataField="TH017" SortField="TH017" Width="100px" HeaderText="批次" />
                                <f:BoundField DataField="TH014" SortField="TH014" Width="100px" HeaderText="订单" />
                            </Columns>
                        </f:Grid>
