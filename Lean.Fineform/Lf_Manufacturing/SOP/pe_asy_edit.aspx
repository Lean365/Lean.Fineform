<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pe_asy_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.SOP.pe_asy_edit" %>
                        ...
                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                            ...
                            <Rows>
                                ...
                                <f:FormRow ID="FormRow8" runat="server">
                                    <Items>
                                        <f:RadioButtonList ID="isengModifysop" Label="SOP变更否" runat="server">
                                ...
                                <f:FormRow ID="FormRow6" runat="server">
                                    <Items>
                                        <f:Label runat="server" ID="pengaModifier" Label="SOP担当" ShowRedStar="True">
                                        </f:Label>
                                    </Items>
                                </f:FormRow>
                            </Rows>
