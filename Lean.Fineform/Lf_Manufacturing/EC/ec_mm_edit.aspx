<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ec_Mm_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.ec_Mm_edit" %>
                            ...
                            <Rows>
                                <f:FormRow ID="FormRow5" runat="server">
                                    <Items>
                                        ...
                                        <f:Label runat="server" ID="Ec_pmclot" Label="预定批次" ShowRedStar="True">
                                        </f:Label>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow ID="FormRow7" runat="server">
                                    <Items>
                                        <f:DatePicker runat="server" Label="出库日期" ID="Ec_mmdate" DateFormatString="yyyyMMdd" ShowRedStar="True" Required="True" FocusOnPageLoad="true">
                                        </f:DatePicker>
                                        <f:TextBox runat="server" ID="Ec_mmlot" Label="出库批次" ShowRedStar="True" Required="True" EmptyText="与生管预定LOT不同时,请输入">
                                        </f:TextBox>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow ID="FormRow2" runat="server">
                                    <Items>
                                        ...
                                        <f:NumberBox Label="领料单号" ID="Ec_mmlotno" runat="server" EmptyText="领料单号"
                                ...
                                <f:FormRow ID="FormRow3" runat="server">
                                    <Items>
                                        <f:TextArea runat="server" ID="Ec_mmnote" Label="注意事项" MaxLength="200" Height="100px" ShowRedStar="True" Required="True" Text="--">
                                        </f:TextArea>
                                    </Items>
                                </f:FormRow>
                ...
                <f:Tab Title="物料确认" BodyPadding="10px" Layout="VBox" runat="server">
                    <Items>
                        <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                            DataKeyNames="ID" AllowSorting="true" OnSort="Grid1_Sort" SortField="Ec_issuedate" ForceFit="true"
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="Ec_location" ColumnID="Ec_location" SortField="Newstock" EnableLock="true" Width="100px" HeaderText="存储位置" />
                            </Columns>
                        </f:Grid>
                    </Items>
                </f:Tab>
