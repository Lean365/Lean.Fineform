<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ec_p2d_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.ec_p2d_edit" %>
                        ...
                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                            ...
                            <Rows>
                                ...
                                <f:FormRow ID="FormRow7" runat="server">
                                    <Items>
                                        <f:DatePicker runat="server" Label="生产日期" ID="Ec_p2ddate" DateFormatString="yyyyMMdd" ShowRedStar="True" Required="True">
                                        </f:DatePicker>
                                ...
                                <f:FormRow ID="FormRow2" runat="server">
                                    <Items>
                                        ...
                                        <f:TextBox Label="生产批次" ID="Ec_p2dlot" runat="server" EmptyText="与生管预定批次不同时,请输入"
                                ...
                                <f:FormRow ID="FormRow3" runat="server">
                                    <Items>
                                        <f:TextBox Label="领料单号" ID="Ec_p2dlotsn" runat="server" Text="44000" Required="True" ShowRedStar="True">
                                        </f:TextBox>
                                    </Items>
                                </f:FormRow>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" ForceFit="true"
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="Protext" SortField="Protext " DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="文本" DataToolTipField="Protext"></f:BoundField>
