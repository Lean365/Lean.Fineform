<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ec_mm.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.ec_mm" %>
                    ...
                    <Items>
                        <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="Ec_mmlotno" SortField="Ec_mmlotno " DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="领料单号"></f:BoundField>
