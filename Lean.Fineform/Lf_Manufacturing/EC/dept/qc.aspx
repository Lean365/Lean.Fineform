<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qc.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.dept.qc" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"  ForceFit="true"                   
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Ec_iqcdate" ColumnID="Ec_iqcdate" SortField="Ec_iqcdate"  EnableLock="true" Width="100px" HeaderText="检验日期"/>  
                        <f:BoundField DataField="Ec_iqcorder" ColumnID="Ec_iqcorder" SortField="Ec_iqcorder"  EnableLock="true" Width="100px" HeaderText="检验订单"/>
