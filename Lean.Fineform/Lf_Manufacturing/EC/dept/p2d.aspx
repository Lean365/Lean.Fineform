<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2d.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.dept.p2d" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"  ForceFit="true"                   
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Ec_p2ddate" ColumnID="Ec_p2ddate" SortField="Ec_p2ddate"  EnableLock="true" Width="100px" HeaderText="领料日期"/>  
                        <f:BoundField DataField="Ec_p2dlot" ColumnID="Ec_p2dlot" SortField="Ec_p2dlot"  EnableLock="true" Width="100px" HeaderText="领料批次"/>
