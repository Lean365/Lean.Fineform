<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pd.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.dept.pd" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"  ForceFit="true"                   
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Ec_purdate" ColumnID="Ec_purdate" SortField="Ec_purdate"  EnableLock="true" Width="100px" HeaderText="采购日期"/>  
                        <f:BoundField DataField="Ec_purorder" ColumnID="Ec_purorder" SortField="Ec_purorder"  EnableLock="true" Width="100px" HeaderText="采购订单"/>
