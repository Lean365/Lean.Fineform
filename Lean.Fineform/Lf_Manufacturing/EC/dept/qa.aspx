<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qa.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.dept.qa" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"  ForceFit="true"                   
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="qaModifyTime" ColumnID="qaModifyTime" SortField="qaModifyTime"  EnableLock="true" Width="100px" HeaderText="登录日期"/> 
