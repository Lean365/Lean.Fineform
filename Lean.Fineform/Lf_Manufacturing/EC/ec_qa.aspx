<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ec_qa.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.ec_qa" %>
...
<head runat="server">
    ...
    <title></title>
    <style type="text/css">
        .f-grid-row .f-grid-cell-Ec_qalot {
            font-size:small;
            /*background-color: #66CCCC;*/
            /*color: #fff;*/
        }

        .f-grid-row .f-grid-cell-Ec_qanote {
           font-size:small;
            /*background-color: #66CCCC;*/
            /*color: #FF0000;*/
        }
        ...
        .f-grid-row .f-grid-cell-Ec_p1dlot {
            font-size: small;
            background-color: #66CCCC;
            color: #FF0000;
        }
                ...
                <f:Region ID="Region2" ShowBorder="false" ShowHeader="false" Position="Center" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPosition="Left" BodyPadding="5px 5px 5px 0" runat="server">
                    <Items>
                        <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                            EnableCheckBoxSelect="false" ForceFit="true" DataKeyNames="ID,Ec_no,Ec_model,Ec_bomitem,Ec_olditem,Ec_newitem" AllowSorting="true" OnSort="Grid2_Sort" SortField="Ec_p1dlot"
                            SortDirection="DESC" AllowPaging="true" IsDatabasePaging="true" OnPreDataBound="Grid2_PreDataBound" AllowCellEditing="true" ClicksToEdit="1" EnableTextSelection="true"
                            OnPreRowDataBound="Grid2_PreRowDataBound" OnRowCommand="Grid2_RowCommand" OnPageIndexChange="Grid2_PageIndexChange" OnRowDataBound="Grid2_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="Ec_qalot" ColumnID="Ec_qalot" SortField="Ec_qalot " DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="检查批次"></f:BoundField>
                                <f:BoundField DataField="Ec_qanote" ColumnID="Ec_qanote" SortField="Ec_qanote " DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="注意事项"></f:BoundField>
                                <%--<f:BoundField DataField="Ec_qanote" SortField="Ec_qanote "  DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="备注事项"></f:BoundField>--%>
                                ...
                                <f:BoundField DataField="Ec_purorder" SortField="Ec_purorder "  DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="订单号码"></f:BoundField>
                                ...
                                <f:BoundField DataField="Ec_pmclot" ColumnID="Ec_pmclot" SortField="Ec_pmclot " DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="生管批次"></f:BoundField>
                                <f:BoundField DataField="Ec_p1dlot" ColumnID="Ec_p1dlot" SortField="Ec_p1dlot " DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="制一批次"></f:BoundField>
                                ...
                                <f:BoundField DataField="Ec_bomitem" ColumnID="Ec_bomitem" SortField="Ec_bomitem " DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="完成品"></f:BoundField>
