<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ec_pm.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.EC.ec_pm" %>
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            ...
            <Regions>
                <f:Region ID="Region1" ShowBorder="false" ShowHeader="false" Width="120px" Position="Left" Layout="Fit" BodyPadding="5px" runat="server">
                    <Items>
                        <f:Grid ID="Grid1" runat="server" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="false" DataKeyNames="ID,Ec_no,Ec_issuedate" AllowSorting="true"
                            OnSort="Grid1_Sort" SortField="Ec_issuedate" SortDirection="DESC" AllowPaging="false" EnableMultiSelect="false" EnableRowDoubleClickEvent="False" EnableTextSelection="true"
                    ...
                    <Items>
                        <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="Ec_pmclot" SortField="Ec_pmclot" DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="生产批次"></f:BoundField>
                                <f:BoundField DataField="Ec_pmcmemo" SortField="Ec_pmcmemo" DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="处理方式"></f:BoundField>
                                <f:BoundField DataField="Ec_pmcnote" SortField="Ec_pmcnote" DataFormatString="{0}" ExpandUnusedSpace="true" HeaderText="注意事项"></f:BoundField>
