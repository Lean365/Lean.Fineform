<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inbound_query.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.SD.shipment.inbound_query" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" ForceFit="true"
                    DataKeyNames="INS001" AllowSorting="true" SortField="INS001" EnableTextSelection="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="INS001" Width="100px" HeaderText="入库日期" />
                        <f:BoundField DataField="INS002" Width="100px" HeaderText="物料" />
                        <f:BoundField DataField="INS003" Width="100px" HeaderText="序列号" />
                        <f:BoundField DataField="INS004" Width="100px" HeaderText="入库数量" />
