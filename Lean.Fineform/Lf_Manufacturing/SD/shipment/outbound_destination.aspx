<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="outbound_destination.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.SD.shipment.outbound_destination" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" ForceFit="true"
                    DataKeyNames="Date" AllowSorting="true" SortField="Date" EnableTextSelection="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Date" Width="100px" HeaderText="出货日期" />                        
                        <f:BoundField DataField="Destination" Width="100px" HeaderText="目的地" />
                        <f:BoundField DataField="Qty" Width="100px" HeaderText="出货数量" />
