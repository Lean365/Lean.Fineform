<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.SD.salesmanage.customer" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    DataKeyNames="GUID,Customer_ID" AllowSorting="true" OnSort="Grid1_Sort" SortField="Customer_ID"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Customer_Org" SortField="Customer_Org" Width="100px" HeaderText="销售组织" />
                        <f:BoundField DataField="Customer_ID" SortField="Customer_ID" Width="100px" HeaderText="客户代码" />
                        <f:BoundField DataField="Customer_Name" SortField="Customer_Name" Width="300px" HeaderText="客户名称" />
                        <f:BoundField DataField="Customer_Abbr" SortField="Customer_Abbr" Width="100px" HeaderText="客户简称" />
