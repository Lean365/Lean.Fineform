<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lot_tracking_oph.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.PP.tracking.lot_tracking_oph" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Pro_StdDeviation" SortField="Pro_StdDeviation" Width="80px" HeaderText="StdDeviation" DataFormatString="{0:f2}" />
                    </Columns>
