...
namespace Fine.Lf_Manufacturing.PP.poor.P2D
{
    ...
    public partial class p2d_inspection_defect_edit : PageBase
    {
        ...
        private void BindData()
        {
            ...
            DefDate.Text = current.Proinspdate;
            // 选中当前节点的父节点
        ...
        private void BindGrid()
        {
            ...
            q = q.Where(u => u.isDelete == 0 && u.Prolinename.Contains(prolinename.Text) && u.Prolot.Contains(prolot.Text) && u.Proinspdate.Contains(ddate));
        ...
        private DataRow CreateNewData(DataTable table, Dictionary<string, object> newAddedData)
        {
            ...
            //生产日期
            rowData["Proinspdate"] = DefDate.Text;
            //订单台数
            ...
            { rowData["Prosideadate"] = ""; }
            else
            {
                rowData["Prosideadate"] = dpProsideadate.SelectedDate.Value.ToString("yyyyMMdd");
            }

            //B面
            if (dpProsidebdate.SelectedDate == null)
            { rowData["Prosidebdate"] = ""; }
            else
            {
                rowData["Prosidebdate"] = dpProsidebdate.SelectedDate.Value.ToString("yyyyMMdd");
            }
            //班别
            rowData["Prodshiftname"] = ddlProdshiftname.SelectedItem.Text;
            //检查
            ...
            //流水
            rowData["Probadserial"] = "";


            //内容
            rowData["Probadcontent"] = "";
        ...
        //    {
        //        string ddate = this.DefDate.Text;
        //        var Pp_Def = DB.Pp_P2d_Inspection_Defects.Where(u => u.isDelete == 0 && u.Prolinename.Contains(prolinename.Text) && u.Prolot.Contains(prolot.Text) && u.Proinspdate.Contains(ddate));
        ...
        //            Pp_P2d_Inspection_Defects.ModifyTime = DateTime.Now;
        //        }
        //        DB.SaveChanges();
        //    }
