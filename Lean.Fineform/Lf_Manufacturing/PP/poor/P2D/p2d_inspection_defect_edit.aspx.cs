...
namespace LeanFine.Lf_Manufacturing.PP.poor.P2D
{
    public partial class p2d_inspection_defect_edit : PageBase
    {
        ...
        public static string strProinspdate, strPromodel, strPropcbtype, strProvisualtype, strProvctype, strProsideadate, strProsidebdate, strProdshiftname, strProcensor, strProorder, strProlot, strProorderqty, strProrealqty, strProispqty, strPropcbchecktype, strProlinename, strProinsqtime, strProaoitime, strProbadqty, strProhandle, strProbadserial, strProbadcontent, strProbadtype;
            ...
            if (AppendToEnd)
            {
                if (newAddedList.Count != 0)
                {
                    for (int i = 0; i < newAddedList.Count; i++)
                    {
                        ...
                        //新建日志
                        string Contectext = item.GUID + "," + strProinspdate + "," + strPromodel + "," + strPropcbtype + "," + strProvisualtype + "," + strProvctype + "," + strProsideadate + "," + strProsidebdate + "," + strProdshiftname + "," + strProcensor + "," + strProorder + "," + strProlot + "," + strProorderqty + "," + strProrealqty + "," + strProispqty + "," + strPropcbchecktype + "," + strProlinename + "," + strProinsqtime + "," + strProaoitime + "," + strProbadqty + "," + strProhandle + "," + strProbadserial + "," + strProbadcontent + "," + strProbadtype;
