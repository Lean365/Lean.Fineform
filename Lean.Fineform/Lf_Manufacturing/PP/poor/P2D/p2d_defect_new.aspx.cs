...
namespace LeanFine.Lf_Manufacturing.PP.poor
{
    public partial class p2d_defect_new : PageBase
    {
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            //更新不具合合计
            UpdatingP2dHelper.Pp_Defect_P2d_BadTotal_Update(this.DefDate.SelectedDate.Value.ToString("yyyyMMdd"), prolinename.SelectedItem.Text, proorder.SelectedItem.Text.Substring(proorder.SelectedItem.Text.IndexOf(",") + 1, proorder.SelectedItem.Text.Length - proorder.SelectedItem.Text.IndexOf(",") - 1), GetIdentityName(), "PCBA");
            //更新无不良台数
