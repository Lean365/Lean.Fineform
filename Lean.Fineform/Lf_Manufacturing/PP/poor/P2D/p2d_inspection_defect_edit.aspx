<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2d_inspection_defect_edit.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.poor.P2D.p2d_inspection_defect_edit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:Label runat="server" ID="lblProinspdate" Label="生产日期" ShowRedStar="True">
                                </f:Label>
