...
namespace LeanFine.Lf_Manufacturing.PP.poor
{
    public partial class p2d_manufacturing_defect_monthly : PageBase
    {
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            Xlsbomitem = DPend.SelectedDate.Value.ToString("yyyyMM") + "_Manufacturing_Defect";
            ...
            try
            {
                ...
                if (q.Any())
                {
                    ...
                    ExportHelper.Manufacturing_XlsxFile(ConvertHelper.LinqConvertToDataTable(qs), "Manufacturing" + DPend.SelectedDate.Value.ToString("yyyyMM"), ExportFileName, DPend.SelectedDate.Value.ToString("yyyyMM"));
                }
                else
