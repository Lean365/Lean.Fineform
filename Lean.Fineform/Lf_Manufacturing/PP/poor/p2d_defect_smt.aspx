<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2d_defect_smt.aspx.cs" Inherits="Lean.Fineform.Lf_Manufacturing.PP.poor.p2d_defect_smt" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:Label ID="promodelqty" runat="server" Label="机种台数" Text="0"></f:Label>
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ForceFit="true" ShowBorder="true" ShowHeader="true" AllowCellEditing="true" ClicksToEdit="2" EnableCheckBoxSelect="true"
                    ...
                    <Columns>
                        ...
                        <f:RenderField Width="200px" ColumnID="Prongdept" DataField="Proorder" HeaderText="生产订单" FieldType="String">
                            <Editor>
                                <f:DropDownList ID="ddlProorder" Required="true" runat="server" EnableEdit="true" ForceSelection="true">
                                </f:DropDownList>
                            </Editor>
                        </f:RenderField>
                        <f:RenderField Width="200px" ColumnID="Prongdept" DataField="Promodel" HeaderText="机种" FieldType="String">
                            <Editor>
                                <f:DropDownList ID="txtPromodel" Required="true" runat="server" EnableEdit="true" ForceSelection="true">
                                </f:DropDownList>
                            </Editor>
                        </f:RenderField>
