...
{
    public partial class p1d_epp_defect : PageBase
    {
        #region ViewPower
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("~/Lf_Manufacturing/PP/poor/P1D/p1d_epp_defect_new.aspx", "新增") + Window1.GetMaximizeReference();
        ...
        private void BindGrid()
        {
            ...
            // 排列和数据库分页
            q = SortAndPage<Pp_P1d_Epp_Defect>(q_include, Grid1);
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                PageContext.RegisterStartupScript(Window1.GetShowReference("~/Lf_Manufacturing/PP/poor/P1D/p1d_epp_defect_edit.aspx?ID=" + keys[0].ToString() + "&type=1") + Window1.GetMaximizeReference());
            }
            ...
            if (e.CommandName == "Delete")
            {
                ...
                //更新不具合合计
                UpdateEppHelper.UpdatebadAmount(current.Prodate, current.Prolinename, current.Proorder, GetIdentityName(), "ASSYE");
