...
{
    public partial class pp_defect_stat_order : PageBase
    {
        #region ViewPower
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("~/Lf_Manufacturing/PP/poor/P1D/pp_defect_stat_order_new.aspx", "新增");
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                PageContext.RegisterStartupScript(Window1.GetShowReference("~/Lf_Manufacturing/PP/poor/P1D/pp_defect_stat_order_edit.aspx?GUID=" + keys[0].ToString() + "&type=1"));
            }
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            IQueryable<Pp_Defect_P1d_Order> q = DB.Pp_Defect_P1d_Orders; //.Include(u => u.Dept);
