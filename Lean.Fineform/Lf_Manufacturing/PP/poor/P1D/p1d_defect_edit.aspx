<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_defect_edit.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.poor.p1d_defect_edit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow ID="FormRow10" runat="server">
                            <Items>
                                <f:NumberBox ID="lblProdzeroefects" runat="server" Label="无不良台数" Text="0" NoDecimal="true" NoNegative="true" Required="true" ShowRedStar="true">
                                </f:NumberBox>
