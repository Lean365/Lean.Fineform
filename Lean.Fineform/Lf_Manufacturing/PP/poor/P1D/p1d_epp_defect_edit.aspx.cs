...
namespace LeanFine.Lf_Manufacturing.PP.poor
{
    public partial class p1d_epp_defect_edit : PageBase
    {
        ...
        public static string Pronotes, Prolot, Prolinename, Prodate, Prorealqty, Probadnote, Proorder, Probadreason, Pronobadqty, Proorderqty, Promodel, Promodelqty, Probadqty, Probadtotal, Probadamount, Prongdept, Probadset;
        ...
        private void BindData()
        {
            ...
            Pronotes = current.Proeppnotes.ToString();
        ...
        private DataRow CreateNewData(DataTable table, Dictionary<string, object> newAddedData)
        {
            ...
            //订单台数
            rowData["Proorderqty"] = (int)Math.Round(decimal.Parse(proorderqty.Text));
            //机种台数
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            UpdateEppHelper.P1d_Defect_Epp_Update_For_Realqty(strPorder, this.DefDate.Text, prolinename.Text, GetIdentityName());
            ...
            //更新不具合合计
            UpdateEppHelper.UpdatebadAmount(this.DefDate.Text, prolinename.Text, strPlot, GetIdentityName(), "ASSYE");
        ...
        private void UpdateNobadqty()
        {
            ...
            {
                string ddate = this.DefDate.Text;
                var Pp_Def = DB.Pp_P1d_Epp_Defects.Where(u => u.IsDeleted == 0 && u.Prolinename.Contains(prolinename.Text) && u.Prolot.Contains(prolot.Text) && u.Prodate.Contains(ddate));
                foreach (var Pp_P1d_Epp_Defects in Pp_Def)
                {
                    Pp_P1d_Epp_Defects.Pronobadqty = int.Parse(this.pronobadqty.Text);
