<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pp_defect_stat_order.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.poor.pp_defect_stat_order" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" EnableTextSelection="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Prodept" SortField="Prodept" Width="100px" HeaderText="区分" />
                        <f:BoundField DataField="Promodel" SortField="Promodel" Width="100px" HeaderText="机种" />
                        <f:BoundField DataField="Proitem" SortField="Proitem" Width="100px" HeaderText="物料" />
