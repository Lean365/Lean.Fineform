<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_defect_new.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.poor.p1d_defect_new" %>
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                ...
                                <f:DropDownList runat="server" ID="ddlProlinename" Label="生产班组" EmptyText="<%$ Resources:GlobalResource,Query_Select%>" ShowRedStar="True" Required="true" EnableEdit="true" ForceSelection="true" AutoPostBack="True" OnSelectedIndexChanged="ddlProlinename_SelectedIndexChanged" TabIndex="2">
                                </f:DropDownList>
                                <f:DropDownList runat="server" ID="ddlProlot" Label="生产LOT" EmptyText="<%$ Resources:GlobalResource,Query_Select%>" ShowRedStar="True" Required="true" EnableEdit="true" ForceSelection="true" AutoPostBack="True" OnSelectedIndexChanged="ddlProlot_SelectedIndexChanged" TabIndex="3">
                                </f:DropDownList>
                            </Items>
                        </f:FormRow>
