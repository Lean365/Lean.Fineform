...
namespace Lean.Fineform.Lf_Manufacturing.PP.poor
{
    ...
    public partial class p2d_defect_edit : PageBase
    {
        ...
        private void LoadData()
        {
            ...
            //IQueryable<Pp_Defect_P2d> q = DB.Pp_Defect_P2ds;
        ...
        private void BindData()
        {
            ...
            Pp_Defect_P2d current = DB.Pp_Defect_P2ds.Find(id);
        ...
        {
            IQueryable<Pp_Defect_P2d> q = DB.Pp_Defect_P2ds; //.Include(u => u.Dept);
            ...
            // 排列和数据库分页
            q = SortAndPage<Pp_Defect_P2d>(q, Grid1);
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                Pp_Defect_P2d current = DB.Pp_Defect_P2ds.Find(del_ID);
                //删除日志
                ...
                //删除记录
                //DB.Pp_Defect_P2ds.Where(l => l.ID == del_ID).Delete();
        ...
        private void EditDefectDataRow()
        {
            ...
            foreach (int rowIndex in deletedRows)
            {
                ...
                Pp_Defect_P2d item = DB.Pp_Defect_P2ds
        ...
        private static void UpdateDefectDataRow(Dictionary<string, object> rowDict, DataRow rowData)
        {
            ...
            Pp_Defect_P2d edititem = DB.Pp_Defect_P2ds
        ...
        private void UpdateNobadqty()
        {
            ...
            {
                string ddate = this.DefDate.Text;
                var Pp_Def = DB.Pp_Defect_P2ds.Where(u => u.isDelete == 0 && u.Prolinename.Contains(prolinename.Text) && u.Prolot.Contains(prolot.Text) && u.Prodate.Contains(ddate));
                foreach (var Pp_Defect_P2ds in Pp_Def)
                {
                    Pp_Defect_P2ds.Pronobadqty = int.Parse(this.pronobadqty.Text);

                    Pp_Defect_P2ds.Modifier = GetIdentityName();
                    Pp_Defect_P2ds.ModifyTime = DateTime.Now;
                }
                DB.SaveChanges();
            }
