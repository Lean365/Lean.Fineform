<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2d_times.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.timesheet.p2d_times" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" EnableTextSelection="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Prolot" SortField="Prolot" ColumnID="Prolot" Width="60px" Hidden="True" HeaderText="批次LOT" />
                        ...
                        <f:BoundField DataField="Propcbatype" SortField="Propcbatype" ColumnID="Propcbatype" Width="60px" Hidden="True" HeaderText="Pcb类别" />
                        <f:BoundField DataField="Propcbaside" SortField="Propcbaside" ColumnID="Propcbaside" Width="60px" Hidden="True" HeaderText="板面" />
                        ...
                        <f:BoundField DataField="Proetime" SortField="Proetime" ColumnID="Proetime" Width="60px" Hidden="True" HeaderText="生产时段" />
                                           <f:BoundField DataField="Proorderqty" SortField="Proorderqty" ColumnID="Proorderqty" Width="60px" Hidden="True" HeaderText="LOT数" />
                        <f:BoundField DataField="Prorealqty" SortField="Prorealqty" ColumnID="Prorealqty" Width="60px" Hidden="True" HeaderText="生产实绩" />
                        <f:BoundField DataField="Prorealtotal" SortField="Prorealtotal" ColumnID="Prorealtotal" Width="60px" Hidden="True" HeaderText="累计生产" />
                        ...
                        <f:BoundField DataField="Propcbastated" SortField="Propcbastated" ColumnID="Propcbastated" Width="60px" Hidden="True" HeaderText="完成状态" />
                        <f:BoundField DataField="Protime" SortField="Protime" ColumnID="Protime" Width="60px" Hidden="True" HeaderText="生产工数" />
