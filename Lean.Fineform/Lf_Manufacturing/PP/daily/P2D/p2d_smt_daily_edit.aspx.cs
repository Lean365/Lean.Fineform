...
{
    public partial class p2d_smt_daily_edit : PageBase
    {
        ...
        private void BindData()
        {
            ...
            Pp_P2d_Smt_Output current = DB.Pp_P2d_Smt_Outputs
            ...
            this.Proline.Text = current.Proline;
            this.Prodate.SelectedDate = DateTime.Parse(current.Prodate);
            ...
            this.Proplanqty.Text = current.Proplanqty.ToString();
            this.Prorealqty.Text = current.Prorealqty.ToString();
            this.Prosmtshortqty.Text = current.Prosmtshortqty.ToString();
            this.Promachineshortqty.Text = current.Promachineshortqty.ToString();

            //修改前日志
            string BeforeModi = current.Prodate + "," + current.Proitem + "," + current.Propcba + "," + current.Proline + "," + current.Prorealqty;
            string OperateType = "修改";
            string OperateNotes = "beEdit* " + BeforeModi + " *beEdit 的记录可能将被修改";
            OperateLogHelper.InsNetOperateNotes(GetIdentityName(), OperateType, "SMT生产", "生产工时修改", OperateNotes);
        }
        ...
        private void SaveItem()//新增生产日报
        {
            //int id = GetQueryIntValue("id");
            Guid guid = Guid.Parse(GetQueryValue("GUID"));
            Pp_P2d_Smt_Output item = DB.Pp_P2d_Smt_Outputs
                .Where(u => u.GUID == guid).FirstOrDefault();
            ...
            //修改后日志
            string ModifiedText = this.Prodate.SelectedDate.Value.ToString("yyyyMMdd") + Proitem.Text + Proline.Text + "," + this.Propcba.Text + "," + this.Prosmtshortqty.Text + "," + this.Promachineshortqty.Text + "," + this.Prorealqty.Text;
