<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2d_smt_short.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.P2D.p2d_smt_short" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    DataKeyNames="GUID,Promodel" AllowSorting="true" OnSort="Grid1_Sort" SortField="Promodel"
