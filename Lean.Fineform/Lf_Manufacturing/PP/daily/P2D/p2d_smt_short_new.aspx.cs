...
{
    public partial class p2d_smt_short_new : PageBase
    {
        //
        ...
        private void CheckData()
        {
            ...
            string InputData = this.Propcba.Text;
        ...
        {
            Pp_P2d_Smt_Short item = new Pp_P2d_Smt_Short();
            ...
            DB.Pp_P2d_Smt_Shorts.Add(item);
            DB.SaveChanges();

            //新增日志
            string Newtext = this.Promodel.Text + "," + this.Proitem.Text + "," + this.Propcbitem.Text + "," + this.Propcba.Text;
