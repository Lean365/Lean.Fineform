    ...
    public partial class p2d_output_query : PageBase
    {
        ...
        private void BindGrid()
        {
            try
            {
                var q =
                    ...
                    group p by new { p.Proorder, p.Proorderqty, p.Prolinename, p.Prodate, p.Prolot, p.Promodel, p.Prohbn, p.Prodirect, p.Prost, p.Proshort, p.Propcbatype } into g
                    select new
                    {
                        g.Key.Prodate,
                        g.Key.Proorder,
        ...
        private void GridSummaryData(DataTable source)
        {
            ...
            foreach (DataRow row in source.Rows)
            {
                ...
                ratio = pTotal != 0 ? rTotal / pTotal : 0;// rTotal / pTotal;
            }
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            Prefix_XlsxName = DpStartDate.SelectedDate.Value.ToString("yyyyMM") + "_OPH_DATA";
            ...
            if (Grid1.RecordCount != 0)
            {
                ...
                ExportHelper.EpplusToExcel(ExportHelper.GetGridDataTable(Grid1), Prefix_XlsxName, Export_FileName, "DTA 生产日报");
