...
{
    public partial class p2d_smt_daily : PageBase
    {
        #region ViewPower
        ...
        private void LoadData()
        {
            ...
            CheckPowerWithButton("CoreP2DSmtOutputNew", btnNew);
            //CheckPowerWithButton("CoreFineExport", BtnExport);
            //CheckPowerWithButton("CoreFineExport", Btn2003);

            btnNew.OnClientClick = Window1.GetShowReference("~/Lf_Manufacturing/PP/daily/P2D/p2d_smt_daily_new.aspx", "新增");
        ...
        {
            IQueryable<Pp_P2d_Smt_Output> q = DB.Pp_P2d_Smt_Outputs; //.Include(u => u.Dept);
            ...
            // 排列和数据库分页
            q = SortAndPage<Pp_P2d_Smt_Output>(q, Grid1);
        ...
        protected void Grid1_PreDataBound(object sender, EventArgs e)
        {
            ...
            CheckPowerWithLinkButtonField("CoreP2DSmtOutputEdit", Grid1, "editField");
            CheckPowerWithLinkButtonField("CoreP2DSmtOutputDelete", Grid1, "deleteField");
        }
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                PageContext.RegisterStartupScript(Window1.GetShowReference("~/Lf_Manufacturing/PP/daily/P2D/p2d_smt_daily_edit.aspx?GUID=" + keys[0].ToString() + "&type=1") + Window1.GetMaximizeReference());
            }
