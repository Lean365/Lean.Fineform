<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2d_smt_daily_edit.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.P2D.p2d_smt_daily_edit" %>
              ...
              <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                  ...
                  <Rows>
                      ...
                      <f:FormRow ID="FormRow6" runat="server">
                          <Items>
                              <f:Label runat="server" ID="Propcbitem" Label="SAP物料" LabelWidth="120" LabelAlign="Right"></f:Label>
                      ...
                      <f:FormRow ID="FormRow7" runat="server">
                          <Items>
                              <f:Label runat="server" Label="PCB品号" ID="Propcba" ShowRedStar="True" LabelAlign="Right">
                              </f:Label>
