...
namespace Lean.Fineform.Lf_Manufacturing.PP.daily
{
    public partial class p1d_daily_sub_edit : PageBase
    {
        ...
        private void BindGrid()
        {
            ...
            IQueryable<Pp_OutputSub> q = DB.Pp_OutputSubs; //.Include(u => u.Dept);
        ...
        private void UpdateDataRow(Dictionary<string, object> rowDict, DataRow rowData)
        {
            ...
            Pp_OutputSub item = DB.Pp_OutputSubs

                .Where(u => u.ID == rowID).FirstOrDefault();

            Pp_Output main_item = DB.Pp_Outputs
            ...
            //同一小时生产多个工单
            var pcount = from a in DB.Pp_OutputSubs
        ...
        private DataRow FindRowByID(int rowID)
        {
            ...
            //IQueryable<Pp_OutputSub> q = DB.Pp_OutputSubs;
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                Pp_OutputSub current = DB.Pp_OutputSubs.Find(del_ID);
                ...
                //删除记录
                DB.Pp_OutputSubs.Where(l => l.ID == del_ID).DeleteFromQuery();
                //重新绑定
                BindGrid();
