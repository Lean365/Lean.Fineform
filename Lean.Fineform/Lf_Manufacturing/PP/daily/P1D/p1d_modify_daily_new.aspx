<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_modify_daily_new.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.p1d_modify_daily_new" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="1px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow ID="FormRow6" runat="server">
                            <Items>
                                <f:Label runat="server" ID="proorder" Label="订单" ShowRedStar="True">
                                </f:Label>
                        ...
                        <f:FormRow ID="FormRow10" runat="server">
                            <Items>
                                <f:DropDownList ID="prohbn" runat="server" Label="品号" ShowRedStar="True" EnableEdit="true" ForceSelection="true" AutoPostBack="True" EmptyText="<%$ Resources:GlobalResource,Query_Select%>" OnSelectedIndexChanged="prohbn_SelectedIndexChanged">
                                </f:DropDownList>
                        ...
                        <f:FormRow ID="FormRow4" runat="server">
                            <Items>
                                <f:NumberBox ID="prolotqty" runat="server" Label="订单数量" Text="0" OnTextChanged="prolotqty_TextChanged" AutoPostBack="true" MaxValue="9999" MinValue="1">
                                </f:NumberBox>
