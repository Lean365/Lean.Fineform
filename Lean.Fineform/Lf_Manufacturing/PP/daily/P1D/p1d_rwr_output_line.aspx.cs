...
{
    public partial class p1d_rpr_output_line : PageBase
    {
        #region ViewPower
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            Prefix_XlsxName = DpStartDate.SelectedDate.Value.ToString("yyyyMM") + "_Rwr(Line)_Output_Report";
            ...
            if (q.Any())
            {
                ...
                ExportHelper.RwrLine_XlsxFile(ConvertHelper.LinqConvertToDataTable(qss), "L" + DpStartDate.SelectedDate.Value.ToString("yyyyMM"), Export_FileName, DpStartDate.SelectedDate.Value.ToString("yyyyMM"));
