<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_epp_daily_date_sub_edit.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.p1d_epp_daily_date_sub_edit" %>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ForceFit="true" ShowBorder="false" ShowHeader="false" AllowCellEditing="true" ClicksToEdit="1" EnableCheckBoxSelect="true"
                    ...
                    <Columns>
                        ...
                        <f:RenderField Width="80px" ColumnID="Prorealqty" DataField="Prorealqty" HeaderText="生产实绩" FieldType="Double">
                            <Editor>
                                <f:NumberBox runat="server" ID="numProrealqty" FocusOnPageLoad="true" MaxValue="9999" MinValue="0" NoDecimal="false" NoNegative="true" DecimalPrecision="0" Required="true" ShowRedStar="true" Increment="1" AutoPostBack="true">
                                </f:NumberBox>
                            </Editor>
                        </f:RenderField>
