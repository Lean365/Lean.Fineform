...
{
    public partial class p1d_epp_daily_new : PageBase
    {
        ...
        private void LoadData()
        {
            ...
            if (compNum == -1)
            {
                this.pikProdate.SelectedDate = DateTime.Now.AddDays(-1);
                this.pikProdate.MinDate = dt_First;
                this.pikProdate.MaxDate = dt_Final;
            }
            if (compNum == 1)
            {
                this.pikProdate.SelectedDate = DateTime.Now.AddDays(-1);
                this.pikProdate.MinDate = lastFirst;
                this.pikProdate.MaxDate = dt_Final;
            }
        ...
        //    //    Pp_Output current = DB.Pp_P1d_Epp_Outputs.Find(del_ID);
        //    //    //删除日志
        ...
        {
            Pp_P1d_Epp_Output item = new Pp_P1d_Epp_Output();
            ...
            DB.Pp_P1d_Epp_Outputs.Add(item);
            DB.SaveChanges();
            //读取ID值
            ...
            string Contectext = ParentID + "," + ddlProlinename.SelectedItem.Text + "," + pikProdate.SelectedDate.Value.ToString("yyyyMMdd") + "," + lblProlot.Text + "," + lblProhbn.Text + "," + lblProstdcapacity.Text;
            ...
            SaveSubItem();
            //删除无单身数据
            UpdateP1dHelper.DelOutputAssySubs(ParentID, ddlProlinename.SelectedItem.Text, pikProdate.SelectedDate.Value.ToString("yyyyMMdd"), lblProlot.Text, lblProhbn.Text, GetIdentityName());
        }
        ...
        private void SaveSubItem()
        {
            try
            {
                ...
                if (res.Any())
                {
                    ...
                    {
                        Pp_P1d_Epp_OutputSub item = new Pp_P1d_Epp_OutputSub();
                        ...
                        item.Creator = GetIdentityName();
                        item.IsDeleted = 0;
                        DB.Pp_P1d_Epp_OutputSubs.Add(item);
                        DB.SaveChanges();

                        //新增日志

                        string Newtext = ParentID + "," + res[i].DictValue + "," + ddlProlinename.SelectedItem.Text + "," + pikProdate.SelectedDate.Value.ToString("yyyyMMdd") + "," + lblProlot.Text + "," + lblProhbn.Text + "," + lblProstdcapacity.Text;
        ...
        private void SaveOrderDefect()
        {
            try
            {
                ...
                //新增日志
                string Contectext = lblProlot.Text + ddlProlinename.SelectedItem.Text + "," + pikProdate.SelectedDate.Value.ToString("yyyyMMdd") + "," + lblProlot.Text + "," + ddlProorder.SelectedItem.Text + "," + lblProlotqty.Text;
                string OperateType = "新增";
        ...
        private void SaveOrderDefectUpdate()
        {
            ...
            var line = (from p in DB.Pp_P1d_Epp_OutputSubs
                            //join b in DB.Pp_P1d_Epp_Outputs on p.OPHID equals b.OPHID
