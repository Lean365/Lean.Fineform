...
namespace LeanFine.Lf_Manufacturing.PP.daily
{
    public partial class p1d_daily_sub_edit : PageBase
    {
        ...
        private void BindGrid()
        {
            ...
            IQueryable<Pp_P1d_OutputSub> q = DB.Pp_P1d_OutputSubs; //.Include(u => u.Dept);
        ...
        private void UpdateDataRow(Dictionary<string, object> rowDict, DataRow rowData)
        {
            ...
            Pp_P1d_Output main_item = DB.Pp_P1d_Outputs
            ...
            //同一小时生产多个工单
            var pcount = from a in DB.Pp_P1d_OutputSubs
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                Pp_P1d_OutputSub current = DB.Pp_P1d_OutputSubs.Find(del_ID);
