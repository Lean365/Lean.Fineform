...
{
    public partial class p1d_modify_daily_edit : PageBase
    {
        ...
        private void BindData()
        {
            ...
            Pp_P1d_Modify_Output current = DB.Pp_P1d_Modify_Outputs.Find(id);
            ...
            promodifynotes.Text = current.Promodifynotes;
            //Editor1.setContent("")
            // 初始化用户所属角色
            ...
            string OperateNotes = "*beEdit改修OPH " + BeforeModi + " *beEdit改修OPH 的记录可能将被修改";

            OperateLogHelper.InsNetOperateNotes(GetIdentityName(), OperateType, "生产管理", "改修OPH修改", OperateNotes);
        }
        ...
        {
            int id = GetQueryIntValue("id");
            Pp_P1d_Modify_Output item = DB.Pp_P1d_Modify_Outputs
            ...
            string OperateType = "修改";
            string OperateNotes = "*afEdit改修OPH " + ModifiedText + "*afEdit改修OPH 的记录已修改";
            OperateLogHelper.InsNetOperateNotes(GetIdentityName(), OperateType, "生产管理", "改修OPH修改", OperateNotes);
        }
        ...
        private void updateSuboph()
        {
            ...
            string OperateType = "修改";
            string OperateNotes = "*afEdit改修OPH_SUB " + ModifiedText + "*afEdit改修OPH_SUB 的记录已修改";

            OperateLogHelper.InsNetOperateNotes(GetIdentityName(), OperateType, "生产管理", "改修OPH_SUB修改", OperateNotes);
        }
