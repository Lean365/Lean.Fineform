<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_epp_daily_date_edit.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.p1d_epp_daily_date_edit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="1px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:Label  runat="server"  Label="生产日期" ID="proStartdate" >
                                </f:Label>
                                <f:Label  runat="server"  Label="生产日期" ID="proEnddate" >
                                </f:Label>
