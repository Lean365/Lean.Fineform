<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_epp_daily_new.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.p1d_epp_daily_new" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="1px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow ID="FormRow3" runat="server">
                            <Items>
                                <f:NumberBox ID="numProst" runat="server" Label="工时" OnTextChanged="numProst_TextChanged" AutoPostBack="true" MaxValue="999" MinValue="1" NoDecimal="false" NoNegative="true" DecimalPrecision="2" Required="true" ShowRedStar="True">
                                </f:NumberBox>
