...
{
    public partial class p1d_epp_daily_date_edit : PageBase
    {
        ...
        private void BindData()
        {
            ...
            Pp_P1d_Epp_Date_Output current = DB.Pp_P1d_Epp_Date_Outputs.Find(id);
            ...
            proStartdate.Text = current.ProStartdate;
            proEnddate.Text = current.ProEnddate;
            // 选中当前节点的父节点
            ...
            //修改前日志
            string BeforeModi = current.ProStartdate + "," + current.Prolinename + "," + current.Prohbn + "," + current.Promodel;
        ...
        {
            int id = GetQueryIntValue("id");
            Pp_P1d_Epp_Date_Output item = DB.Pp_P1d_Epp_Date_Outputs
            ...
            //修改后日志
            string ModifiedText = prolinename.Text.Trim() + "," + proEnddate.Text + "," + prolot.Text + "," + prohbn.Text + "," + promodel.Text;
            string OperateType = "修改";
