<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_modify_daily_sub_edit.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.p1d_modify_daily_sub_edit" %>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ForceFit="true" ShowBorder="false" ShowHeader="false" AllowCellEditing="true" ClicksToEdit="1" EnableCheckBoxSelect="true"
                    ...
                    <Columns>
                        ...
                        <f:RenderField Width="80px" ColumnID="Prorealqty" DataField="Prorealqty" HeaderText="生产实绩" FieldType="Int">
                            <Editor>
                                <f:NumberBox ID="numProrealqty" FocusOnPageLoad="true" NoDecimal="true" NoNegative="true" MinValue="0" MaxValue="1000" runat="server" AutoPostBack="true">
                                </f:NumberBox>
                            </Editor>
                        </f:RenderField>
