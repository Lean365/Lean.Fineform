<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_epp_daily_date.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.p1d_epp_date_daily" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" 
                    ...
                    DataKeyNames="ID,Prolinename,ProStartdate,Prolot,Promodel,Prost,Prostdcapacity,Proorder" AllowSorting="true" OnSort="Grid1_Sort" SortField="ID"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="ProStartdate" SortField="ProStartdate" Width="80px" HeaderText="起始日" />
                        <f:BoundField DataField="ProEnddate" SortField="ProEnddate" Width="80px" HeaderText="结束日" />
