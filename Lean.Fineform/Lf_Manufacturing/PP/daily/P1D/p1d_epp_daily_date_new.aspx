<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1d_epp_daily_date_new.aspx.cs" Inherits="LeanFine.Lf_Manufacturing.PP.daily.p1d_epp_daily_date_new" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="1px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:DatePicker FocusOnPageLoad="true" runat="server" Required="true" Label="起始日" DateFormatString="yyyyMMdd" EmptyText="请选择生产日期"
                                    ID="pikProStartdate" ShowRedStar="True">
                                </f:DatePicker>
                                <f:DatePicker FocusOnPageLoad="true" runat="server" Required="true" Label="结束日" DateFormatString="yyyyMMdd" EmptyText="请选择生产日期"
                                    ID="pikProEnddate" ShowRedStar="True">
                                </f:DatePicker>
