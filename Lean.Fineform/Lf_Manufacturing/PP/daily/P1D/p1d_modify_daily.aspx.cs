...
{
    public partial class p1d_modify_daily : PageBase
    {
        #region ViewPower
        ...
        private void LoadData()
        {
            ...
            btnP1dNew.OnClientClick = Window1.GetShowReference("~/Lf_Manufacturing/PP/daily/P1D/p1d_modify_daily_new.aspx", "新增") + Window1.GetMaximizeReference();
        ...
        private void BindGrid()
        {
            ...
            IQueryable<Pp_P1d_Modify_Output> q = DB.Pp_P1d_Modify_Outputs; //.Include(u => u.Dept);
            ...
            // 排列和数据库分页
            q = SortAndPage<Pp_P1d_Modify_Output>(q_include, Grid1);
        ...
        //    //DB.SaveChanges();
        //    DB.Pp_P1d_Modify_OutputSubs.Where(u => ids.Contains(u.Parent.ID)).Delete();
        //    DB.Pp_P1d_Modify_Outputs.Where(u => ids.Contains(u.ID)).Delete();
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                //labResult.Text = keys[0].ToString();
                PageContext.RegisterStartupScript(Window1.GetShowReference("~/Lf_Manufacturing/PP/daily/P1D/p1d_modify_daily_edit.aspx?ID=" + keys[0].ToString() + "&type=1") + Window1.GetMaximizeReference());
            }
            if (e.CommandName == "EditOphsub")
            {
                //labResult.Text = keys[0].ToString();
                PageContext.RegisterStartupScript(Window1.GetShowReference("~/Lf_Manufacturing/PP/daily/P1D/p1d_modify_daily_sub_edit.aspx?Transtr=" + tracestr + "&type=1") + Window1.GetMaximizeReference());
            }
            ...
            if (e.CommandName == "Delete")
            {
                ...
                Pp_P1d_Modify_Output current = DB.Pp_P1d_Modify_Outputs.Find(del_ID);
                ...
                DB.Pp_P1d_Modify_OutputSubs.Where(l => l.Parent == del_ID).DeleteFromQuery();
                DB.Pp_P1d_Modify_Outputs.Where(l => l.ID == del_ID).DeleteFromQuery();
        ...
        {            // 在操作之前进行权限检查
            ...
            var q =
                ...
                join b in DB.Pp_P1d_Modify_Outputs on p.GUID equals b.GUID
                where p.IsDeleted == 0
            ...
            if (qs.Any())
            {
                ...
                ExportHelper.EpplusToExcel(ConvertHelper.LinqConvertToDataTable(qs), Prefix_XlsxName, Export_FileName, "DTA 改修日报");
