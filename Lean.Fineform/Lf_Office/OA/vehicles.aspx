<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vehicles.aspx.cs" Inherits="Lean.Fineform.Lf_Office.OA.vehicles" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            ShowHeader="false" Title="用车管理">
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    EnableCheckBoxSelect="true"
                    DataKeyNames="ID,Vehicle_Stime" AllowSorting="true" OnSort="Grid1_Sort" SortField="Vehicle_Stime"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Vehicle_Name" SortField="Vehicle_Name" Width="150px" HeaderText="名称" />
                        <f:BoundField DataField="Vehicle_Driver" SortField="Vehicle_Driver" Width="100px" HeaderText="司机" />
                        <f:BoundField DataField="Vehicle_Stime" SortField="Vehicle_Stime" Width="100px" HeaderText="开始时间" />
                        <f:BoundField DataField="Vehicle_Etime" SortField="Vehicle_Etime" Width="350px" HeaderText="结束时间" />
                        <f:BoundField DataField="Vehicle_State" SortField="Vehicle_State" Width="150px" HeaderText="状态" />
