<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notice.aspx.cs" Inherits="Lean.Fineform.Lf_Office.OA.notice" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    DataKeyNames="GUID,Notice_Pubdate" AllowSorting="true" OnSort="Grid1_Sort" SortField="Notice_Pubdate"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Notice_Pubdate" SortField="Notice_Pubdate" Width="100px" HeaderText="日期" />
                        <f:BoundField DataField="lineNotice_Typecode" SortField="Notice_Type" Width="100px" HeaderText="类别" />
                        <f:BoundField DataField="Notice_Category" SortField="Notice_Category" Width="100px" HeaderText="分类" />
                        <f:BoundField DataField="Notice_Title" SortField="Notice_Title" Width="100px" HeaderText="标题" />
                        <f:BoundField DataField="Notice_Issuer" SortField="Notice_Issuer" Width="100px" HeaderText="发行" />
                        <f:BoundField DataField="Notice_Attachments" SortField="Notice_Attachments" Width="100px" HeaderText="附件" />
                        <f:BoundField DataField="Notice_Contents" SortField="Notice_Contents" Width="100px" HeaderText="内容" />
