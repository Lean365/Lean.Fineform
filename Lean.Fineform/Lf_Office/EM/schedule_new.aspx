<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="schedule_new.aspx.cs" Inherits="Lean.Fineform.Lf_Office.EM.schedule_new" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:DropDownList runat="server" ID="attypename" Label="事件类型" AutoPostBack="true" Required="true" ShowRedStar="true" AutoSelectFirstItem="false" OnSelectedIndexChanged="attypename_SelectedIndexChanged" EmptyText="<%$ Resources:GlobalResource,Query_Select%>">
                                </f:DropDownList>
                                <f:TextBox runat="server" ID="attitle" Label="标题" ShowRedStar="True" Required="True">
                                </f:TextBox>
                        ...
                        <f:FormRow ID="FormRow3" runat="server">
                            <Items>
                                <f:TriggerBox ID="atsdate" Required="true" ShowRedStar="True" Label="<%$ Resources:GlobalResource,Query_Startdate%>" EmptyText="<%$ Resources:GlobalResource,Query_Startdate_EmptyText%>" TriggerIcon="Date"
                                    EnablePostBack="false" runat="server" OnClientTriggerClick="atsdateTriggerClick();">
                                </f:TriggerBox>
                                <f:TriggerBox ID="atedate" Required="true" ShowRedStar="True" Label="<%$ Resources:GlobalResource,Query_Enddate%>" EmptyText="<%$ Resources:GlobalResource,Query_Startdate_EmptyText%>" TriggerIcon="Date"
