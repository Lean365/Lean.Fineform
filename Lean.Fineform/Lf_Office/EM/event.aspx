<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="event.aspx.cs" Inherits="Lean.Fineform.Lf_Office.EM._event" %>
            ...
            <Items>
                <f:Form ID="Form2" runat="server" Height="36px" BodyPadding="5px" ShowHeader="false"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="<%$ Resources:GlobalResource,Query_Em_EmptyText%>"
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="attypename" SortField="attypename" Width="100px" HeaderText="事件类型" />
                        <f:BoundField DataField="atuser" SortField="atuser" Width="100px" HeaderText="用户名" />
                        <f:BoundField DataField="attitle" SortField="attitle" Width="100px" HeaderText="事件标题" />
                        <f:BoundField DataField="atcontent" SortField="atcontent" Width="300px" HeaderText="事件内容" />
                        <f:BoundField DataField="atsdate" SortField="atsdate" Width="150px" HeaderText="开始时间" />
                        <f:BoundField DataField="atedate" SortField="atedate" Width="150px" HeaderText="结束时间" />
                        ...
                        <f:LinkButtonField ColumnID="deleteField" TextAlign="Center" Icon="Delete"
                            ...
                            ConfirmTarget="Top" CommandName="Delete" Width="80px" />
                    </Columns>
                </f:Grid>
            </Items>
        </f:Panel>
