...
namespace LeanFine.Lf_Accounting
{
    public partial class costing_inventoryamt : PageBase
    {
        ...
        {            // 在操作之前进行权限检查
            ...
            Prefix_XlsxName = DpEndDate.SelectedDate.Value.ToString("yyyyMM") + "_库存表";
            ...
            if (Grid1.RecordCount != 0)
            {
                ...
                ExportHelper.EpplusToExcel(ExportHelper.GetGridDataTable(Grid1), Prefix_XlsxName, Export_FileName, "DTA 存货明细");
