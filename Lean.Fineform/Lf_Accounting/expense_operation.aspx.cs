...
namespace LeanFine.Lf_Accounting
{
    public partial class expense_operation : PageBase
    {
        ...
        private void BindGrid()
        {
            ...
            q = q.Where(u => u.Bc_TitleName.Contains("营业费用"));
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            if (qs.Any())
            {
                ...
                ExportHelper.EpplusToExcel(ConvertHelper.LinqConvertToDataTable(qs), Prefix_XlsxName, Export_FileName, "DTA 营业费用明细");
