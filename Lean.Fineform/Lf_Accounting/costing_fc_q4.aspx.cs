...
{
    public partial class costing_fc_q4 : PageBase
    {
        #region ViewPower
        ...
        protected void Grid1_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            {
                // 1增减
                int DiffQty01 = Convert.ToInt32(row["DiffQty'01"]);
                FineUIPro.BoundField cDiffQty01 = Grid1.FindColumn("DiffQty'01") as FineUIPro.BoundField;
                if (DiffQty01 > 0)
                {
                    e.CellCssClasses[cDiffQty01.ColumnIndex] = "color1";
                }
                if (DiffQty01 == 0)
                {
                    e.CellCssClasses[cDiffQty01.ColumnIndex] = "color2";
                }
                if (DiffQty01 < 0)
                {
                    e.CellCssClasses[cDiffQty01.ColumnIndex] = "color3";
                }
                // 2增减
                int DiffQty02 = Convert.ToInt32(row["DiffQty'02"]);
                FineUIPro.BoundField cDiffQty02 = Grid1.FindColumn("DiffQty'02") as FineUIPro.BoundField;
                if (DiffQty02 > 0)
                {
                    e.CellCssClasses[cDiffQty02.ColumnIndex] = "color1";
                }
                if (DiffQty02 == 0)
                {
                    e.CellCssClasses[cDiffQty02.ColumnIndex] = "color2";
                }
                if (DiffQty02 < 0)
                {
                    e.CellCssClasses[cDiffQty02.ColumnIndex] = "color3";
                }
                // 3增减
                int DiffQty03 = Convert.ToInt32(row["DiffQty'03"]);
                FineUIPro.BoundField cDiffQty03 = Grid1.FindColumn("DiffQty'03") as FineUIPro.BoundField;
                if (DiffQty03 > 0)
                {
                    e.CellCssClasses[cDiffQty03.ColumnIndex] = "color1";
                }
                if (DiffQty03 == 0)
                {
                    e.CellCssClasses[cDiffQty03.ColumnIndex] = "color2";
                }
                if (DiffQty03 < 0)
                {
                    e.CellCssClasses[cDiffQty03.ColumnIndex] = "color3";
                }
            }
        }
