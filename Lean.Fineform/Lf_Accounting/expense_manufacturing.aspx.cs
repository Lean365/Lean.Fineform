...
{
    public partial class expense_manufacturing : PageBase
    {
        #region ViewPower
        ...
        private void BindGrid()
        {
            ...
            q = q.Where(u => u.Bc_TitleName.Contains("制造费用"));
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            var qs = from p in q
                     select new
                     {
                         ...
                         科目 = p.Bc_TitleCode,
                         名称 = p.Bc_TitleName,
                         预算Amt = p.BC_BudgetAmt,
                         实际Amt = p.Bc_ActualAmt,
                         差异Amt = p.Bc_DiffAmt,
                         比率 = p.Bc_DiffAmt / p.BC_BudgetAmt
                     };
            if (qs.Any())
            {
                ...
                ExportHelper.EpplusToExcel(ConvertHelper.LinqConvertToDataTable(qs), Prefix_XlsxName, Export_FileName, "DTA 制造费用明细");
