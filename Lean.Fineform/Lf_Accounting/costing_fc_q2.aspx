<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="costing_fc_q2.aspx.cs" Inherits="LeanFine.Lf_Accounting.costing_fc_q2" %>
                    ...
                    <Columns>
                        ...
                        <f:GroupField ID="HT_FY" TextAlign="Center" runat="server">
                            <Columns>
                                ...
                                <f:GroupField HeaderText="'07" TextAlign="Center">
                                    <Columns>


                                        <f:GroupField ID="HT_Vera04" runat="server" HeaderText="001" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtya'07" HeaderText="数量" TextAlign="Center" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:GroupField ID="HT_Verb04" runat="server" HeaderText="999" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtyb'07" HeaderText="数量" TextAlign="Center" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:BoundField Width="80px" ColumnID="DiffQty'07" DataField="DiffQty'07" HeaderText="增减" TextAlign="Center" />
                                    </Columns>
                                </f:GroupField>
                                <f:GroupField HeaderText="'08" TextAlign="Center">
                                    <Columns>
                                        <f:GroupField ID="HT_Vera05" runat="server" HeaderText="001" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtya'08" HeaderText="数量" TextAlign="Right" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:GroupField ID="HT_Verb05" runat="server" HeaderText="999" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtyb'08" HeaderText="数量" TextAlign="Right" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:BoundField Width="80px" ColumnID="DiffQty'08" DataField="DiffQty'08" HeaderText="增减" TextAlign="Right" />
                                    </Columns>
                                </f:GroupField>
                                <f:GroupField HeaderText="'09" TextAlign="Center">
                                    <Columns>
                                        <f:GroupField ID="HT_Vera06" runat="server" HeaderText="001" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtya'09" HeaderText="数量" TextAlign="Right" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:GroupField ID="HT_Verb06" runat="server" HeaderText="999" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtyb'09" HeaderText="数量" TextAlign="Right" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:BoundField Width="80px" ColumnID="DiffQty'09" DataField="DiffQty'09" HeaderText="增减" TextAlign="Right" />
                                    </Columns>
                                </f:GroupField>
                            </Columns>
                        </f:GroupField>
