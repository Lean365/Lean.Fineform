...
{
    public partial class expense_finance : PageBase
    {
        #region ViewPower
        ...
        private void BindGrid()
        {
            ...
            q = q.Where(u => u.Bc_TitleName.Contains("财务费用"));
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            if (qs.Any())
            {
                ...
                ExportHelper.EpplusToExcel(ConvertHelper.LinqConvertToDataTable(qs), Prefix_XlsxName, Export_FileName, "DTA 财务费用明细");
