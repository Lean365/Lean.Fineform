...
namespace LeanFine.Lf_Accounting
{
    public partial class expense : PageBase
    {
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            if (rbtnThirdAuto.Checked)
            {
                Prefix_XlsxName = global::Resources.GlobalResource.sys_Tab_Fico_Expense_Manufacturing + "_" + DpEndDate.SelectedDate.Value.ToString("yyyyMM");
            }
            if (rbtnFourthAuto.Checked)
            {
                Prefix_XlsxName = global::Resources.GlobalResource.sys_Tab_Fico_Expense_Operation + "_" + DpEndDate.SelectedDate.Value.ToString("yyyyMM");
            }
            if (rbtnFifthAuto.Checked)
            {
                Prefix_XlsxName = global::Resources.GlobalResource.sys_Tab_Fico_Expense_ProdCost + "_" + DpEndDate.SelectedDate.Value.ToString("yyyyMM");
            }
            if (rbtnSixthAuto.Checked)
            {
                Prefix_XlsxName = "费用明细对比_" + DpEndDate.SelectedDate.Value.ToString("yyyyMM");
            }
            ...
            if (Grid1.RecordCount != 0)
            {
                ...
                ExportHelper.EpplusToExcel(ExportHelper.GetGridDataTable(Grid1), Prefix_XlsxName, Export_FileName, "DTA 费用对比明细");
