<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fico_accountingtitle_cost.aspx.cs" Inherits="Lean.Fineform.Lf_Accounting.Fico_accountingtitle_cost" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" ForceFit="true"
                    DataKeyNames="Bc_CostCode" AllowSorting="true" SortField="Bc_CostCode" EnableTextSelection="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Bc_TitleNote" Width="100px" HeaderText="类别" />
