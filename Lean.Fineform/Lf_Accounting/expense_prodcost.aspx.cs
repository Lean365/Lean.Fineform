...
{
    public partial class expense_prodcost : PageBase
    {
        #region ViewPower
        ...
        private void BindGrid()
        {
            ...
            q = q.Where(u => u.Bc_TitleName.Contains("生产成本"));
        ...
        protected void BtnExport_Click(object sender, EventArgs e)
        {
            ...
            if (qs.Any())
            {
                ...
                ExportHelper.EpplusToExcel(ConvertHelper.LinqConvertToDataTable(qs), Prefix_XlsxName, Export_FileName, "DTA 生产成本明细");
