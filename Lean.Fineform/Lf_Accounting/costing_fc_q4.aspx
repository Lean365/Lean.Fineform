<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="costing_fc_q4.aspx.cs" Inherits="Lean.Fineform.Lf_Accounting.costing_fc_q4" %>
                    ...
                    <Columns>
                        ...
                        <f:GroupField ID="HT_FY" TextAlign="Center" runat="server">
                            <Columns>
                                ...
                                <f:GroupField HeaderText="'01" TextAlign="Center">
                                    <Columns>


                                        <f:GroupField ID="HT_Vera04" runat="server" HeaderText="001" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtya'01" HeaderText="数量" TextAlign="Center" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:GroupField ID="HT_Verb04" runat="server" HeaderText="999" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtyb'01" HeaderText="数量" TextAlign="Center" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:BoundField Width="80px" ColumnID="DiffQty'01" DataField="DiffQty'01" HeaderText="增减" TextAlign="Center" />
                                    </Columns>
                                </f:GroupField>
                                <f:GroupField HeaderText="'02" TextAlign="Center">
                                    <Columns>
                                        <f:GroupField ID="HT_Vera05" runat="server" HeaderText="001" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtya'02" HeaderText="数量" TextAlign="Right" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:GroupField ID="HT_Verb05" runat="server" HeaderText="999" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtyb'02" HeaderText="数量" TextAlign="Right" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:BoundField Width="80px" ColumnID="DiffQty'02" DataField="DiffQty'02" HeaderText="增减" TextAlign="Right" />
                                    </Columns>
                                </f:GroupField>
                                <f:GroupField HeaderText="'03" TextAlign="Center">
                                    <Columns>
                                        <f:GroupField ID="HT_Vera06" runat="server" HeaderText="001" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtya'03" HeaderText="数量" TextAlign="Right" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:GroupField ID="HT_Verb06" runat="server" HeaderText="999" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="Qtyb'03" HeaderText="数量" TextAlign="Right" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:BoundField Width="80px" ColumnID="DiffQty'03" DataField="DiffQty'03" HeaderText="增减" TextAlign="Right" />
                                    </Columns>
                                </f:GroupField>
                            </Columns>
                        </f:GroupField>
