<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="corpkpi_new.aspx.cs" Inherits="Lean.Fineform.Lf_Admin.corpkpi_new" %>
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" AutoScroll="true" runat="server">
            ...
            <Items>
                <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
                    ...
                    <Items>
                        <f:DropDownList ID="ddlCorpAbbrName" runat="server" Label="公司名称" Required="true" ShowRedStar="true">
                        </f:DropDownList>
                        <f:DropDownList ID="ddlCorpAnnual" runat="server" Label="年度" Required="true" ShowRedStar="true">
                        </f:DropDownList>
