<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="online.aspx.cs" Inherits="Lean.Fineform.Lf_Admin.online" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    EnableCheckBoxSelect="false" DataKeyNames="ID" AllowSorting="true" ForceFit="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="LoginNum" ExpandUnusedSpace="true" HeaderText="次数" />
                        
                        <f:WindowField Text="查看" Title="查看" WindowID="Window1" DataIFrameUrlFields="User.ID"
                            DataIFrameUrlFormatString="~/Lf_Admin/user_view.aspx?id={0}" Width="50px" />
                    </Columns>
                    <PageItems>
