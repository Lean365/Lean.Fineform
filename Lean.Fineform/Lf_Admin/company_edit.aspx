<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="company_edit.aspx.cs" Inherits="Lean.Fineform.Lf_Admin.company_edit" %>
                                ...
                                <f:GroupPanel ID="GroupPanel1" Layout="Anchor" Title="机构信息" runat="server">
                                    <Items>
                                        <f:Panel ID="Panel2" Layout="HBox" ShowHeader="false" ShowBorder="false" runat="server">
                                            <Items>
                                                <f:Label ID="Label1" runat="server" ShowRedStar="true" Label="机构类型" LabelAlign="Right"></f:Label>
                                        ...
                                        <f:Panel ID="Panel1"  ShowHeader="false" ShowBorder="false" runat="server">
                                            <Items>
                                                <f:Label ID="TXTentOrgCode" runat="server" Label="机构代码" ShowRedStar="True" LabelAlign="Right">
                                                </f:Label>
                                                ...
                                                <f:Label ID="TXTentabbrName" runat="server" Label="英文简称" ShowRedStar="True" LabelAlign="Right">
                                                </f:Label>
                                                <f:Label ID="TXTentShortName" runat="server" Label="机构简称" ShowRedStar="True" LabelAlign="Right">
                                                </f:Label>
