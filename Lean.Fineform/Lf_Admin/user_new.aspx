<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_new.aspx.cs" Inherits="Lean.Fineform.Lf_Admin.user_new" %>
...
<body>
            ...
            <Items>
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow runat="server">
                            <Items>
                                <f:TextBox ID="tbxEnglishName" runat="server" Label="英文名" Required="true" ShowRedStar="true">
                                </f:TextBox>
                                <f:TextBox ID="tbxChineseName" runat="server" Label="中文名" Required="true" ShowRedStar="true">
                                </f:TextBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow runat="server">
                        ...
                        <f:FormRow ID="FormRow6" runat="server">
                            <Items>
                                <f:TextBox ID="tbxAddress" runat="server" Label="地址">
                                </f:TextBox>
    ...
    <script>
        ...
        function onSelectedDeptTrigger2Click() {
            F('Window1').show(F.baseUrl + 'Lf_Admin/user_select_dept.aspx?ids=' + F(hfSelectedDeptClientID).getValue() + '', '选择用户所属的部门');
        }
        ...
        function onSelectedTitleTrigger2Click() {
            F('Window1').show(F.baseUrl + 'Lf_Admin/user_select_title.aspx?ids=' + F(hfSelectedTitleClientID).getValue() + '', '选择用户拥有的职称');
        }
